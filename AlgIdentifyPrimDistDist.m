...
% required for the intensity-based algorithm, nor do they need to be
...
% are touching each other.  To identify the edges of non-clumped
% objects, a simple threshold is applied. Objects on the border of the
% image are ignored, and the user can select a size range, outside
% which objects will be ignored.
%
