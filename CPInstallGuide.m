...
% 		ans = 0
% 
% 2. Copy the CellProfilerTM files to a folder named CellProfiler on your
% computer (any location is fine).  Do not moveor rename this folder or any
...
% 
% 
% Please note that CellProfilerTM was designed to work with the following
% Mac system and has not been extensively tested on other
% platforms/versions, although we routinely run the software on Windows and
% UNIX systems. If you encounter problems, check the command window of
% Matlab for error messages.
% 
