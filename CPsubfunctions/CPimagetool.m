...
if ~isempty(varargin)
    ...
    if ~isempty(ImageToolWindowHandle)
        ...
        NewWindow =     uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .78 .9 .12],'string','Open in new window','BackgroundColor',[.7 .7 .9],'FontSize',FontSize);
        Histogram =     uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .64 .9 .12],'string','Show intensity histogram','Tag','Histogram','BackgroundColor',[.7 .7 .9],'FontSize',FontSize);
        MeasureLength = uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .50 .9 .12],'string','Measure Length','Tag','MeasureLength','BackgroundColor',[.7 .7 .9],'FontSize',FontSize);
        MatlabWS  =     uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .36 .9 .12],'string','Save to work space','BackgroundColor',[.7 .7 .9],'FontSize',FontSize);
        SaveImageAs=    uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .22 .9 .12],'string','Save to hard drive','BackgroundColor',[.7 .7 .9],'FontSize',FontSize);
        Cancel    =     uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.25 .05 .7 .12],'string','Cancel','BackgroundColor',[.7 .7 .9],'FontSize',FontSize);
        Help    =       uicontrol(ImageToolWindowHandle,'style','pushbutton','units','normalized','position',[.05 .05 .15 .12],'string','?','BackgroundColor',[.7 .7 .9],'FontSize',FontSize);
