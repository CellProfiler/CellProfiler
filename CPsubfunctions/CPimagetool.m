        ...
        switch action
            ...
            case {'ChangeColormap'}                         % Change colormap of the whole figure
                ...
                if ~isempty(ChangeColormapHandle)
                    ...
                    SelectColormapText = uicontrol(ChangeColormapHandle,'style','text','units','normalized','position',[.055 .4 .56 .35],'string','Please specify the colormap to use.   Note: this will have effect in the whole figure, not just the selected image.','BackgroundColor',[.7 .7 .9],'FontSize',FontSize,'HorizontalAlignment','left');
                    ...
                    uicontrol(ChangeColormapHandle,'Style','popupmenu','Units','normalized','Position',[0.685 0.55 .26 .2],'String',{'default' 'autumn' 'bone' 'colorcube' 'cool' 'copper' 'flag' 'gray' 'hot' 'hsv' 'jet' 'lines' 'pink' 'prism' 'spring' 'summer' 'white' 'winter'},'BackgroundColor',[1 1 1],'FontSize',FontSize,'Tag','ChangeColormapPopupMenu','Value',1);
