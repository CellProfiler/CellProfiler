...
'String', ['You can add your own tools by writing Matlab m-files, placing them in the ', ImageDataOrHelp, ' folder, and restarting CellProfiler. To view help for an individual ' ImageDataOrHelp ', choose one below:'],...
'Style','text',...
'Tag','informtext');
...
'NumberTitle','off',...
'PaperPosition',get(0,'defaultfigurePaperPosition'),...
'Position',[pos1(1)+pos2(1)+pos2(3) pos1(2)+pos2(2) 134.5 33],...
'Resize','off',...
'HandleVisibility','callback',...
'Tag','AddModuleWindow',...
'UserData',[],...
...
'Interruptible','off',...
'Max',2,...
'Position',[3.166666666666 11 22.8333333333333 17],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'Interruptible','off',...
'Max',2,...
'Position',[29.16666666666 11 22.8333333333333 17],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'Interruptible','off',...
'Max',2,...
'Position',[55.166666666666 11 22.8333333333333 17],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'Interruptible','off',...
'Max',2,...
'Position',[81.16666666666 11 22.8333333333333 17],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'Interruptible','off',...
'Max',2,...
'Position',[107.16666666666 11 22.8333333333333 17],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
'Tag','OtherListBox',...
...
'FontName','Helvetica',...
'Max',2,...
'Position',[4.166666666667 28 21.6666666666667 2.08333333333333],...
...
'FontSize',font,...
'FontName','Helvetica',...
'Position',[30.166666666666 28 21.6666666666667 2.08333333333333],...
...
'FontSize',font,...
'FontName','Helvetica',...
'Position',[56.16666666666 28 21.6666666666667 2.08333333333333333],...
...
'FontSize',font,...
'FontName','Helvetica',...
'Position',[82.166666666667 28 21.6666666666667 2.08333333333333],...
'String','Measurement',...
'Style','text',...
...
'FontSize',font,...
'FontName','Helvetica',...
'Position',[108.16666666667 28 21.6666666666667 2.08333333333333],...
'String','Other',...
'Style','text',...
