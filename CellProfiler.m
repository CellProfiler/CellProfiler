...
handles.CPlogoAxes = axes('Position',[.01 .85 .1 .15],...
...
ColorMapHelp = uicontrol(...
    ...
    'Units','normalized',...
    'BackgroundColor',Color,...
    'Callback','CPtextdisplaybox(help(''HelpColormaps''),[''Colormaps Help'']);',...
    'FontWeight','bold',...
    'Position',[0.18 0.64 0.02 0.04],...
    'String','?',...
    'Tag','ColorMapHelp',...
    'Behavior',get(0,'defaultuicontrolBehavior'));
...
PixelSizeHelp = uicontrol(...
    ...
    'Units','normalized',...
    'BackgroundColor',Color,...
    'Callback','CPtextdisplaybox(help(''HelpPixelSize''),[''Pixel Size Help'']);',...
    'FontWeight','bold',...
...
FastModeHelp = uicontrol(...
    ...
    'Units','normalized',...
    'BackgroundColor',Color,...
    'Callback','CPtextdisplaybox(help(''HelpFastMode''),[''Fast Mode Help'']);',...
    'FontWeight','bold',...
...
SkipErrorHelp = uicontrol(...
    ...
    'Units','normalized',...
    'BackgroundColor',Color,...
    'Callback','CPtextdisplaybox(help(''HelpSkipErrors''),[''Skip Errors Help'']);',...
    'FontWeight','bold',...
