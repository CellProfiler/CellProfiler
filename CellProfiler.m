...
if ok ~= 0
    ...
    if isempty(Answers) ~= 1
        ...
        if strcmp(CompressedHistogram,'no') == 1
            ...
            %%% window.
            Button1Callback = 'FigureHandle = gcf; AxesHandles = findobj(''Parent'', FigureHandle, ''Type'', ''axes''); propedit(AxesHandles,''v6''); drawnow';
            ...
            ButtonHandle2 = uicontrol('Parent',FigureHandle, ...
                ...
                'String','Current', ...
                'Style','pushbutton');
            Button3Callback = 'FigureHandles = findobj(''Parent'', 0); AxesHandles = findobj(FigureHandles, ''Type'', ''axes''); axis(AxesHandles, ''manual''); propedit(AxesHandles,''v6''); drawnow';
            ButtonHandle3 = uicontrol('Parent',FigureHandle, ...
                ...
                'String','All windows', ...
                'Style','pushbutton');
            Button4Callback = 'FigureHandle = gcf; PatchHandles = findobj(FigureHandle, ''Type'', ''patch''); propedit(PatchHandles,''v6''); drawnow';
            ButtonHandle4 = uicontrol('Parent',FigureHandle, ...
                ...
                'String','This window', ...
                'Style','pushbutton');
            Button5Callback = 'AxisHandle = gca; PatchHandles = findobj(''Parent'', AxisHandle, ''Type'', ''patch''); propedit(PatchHandles,''v6''); drawnow';
            ButtonHandle5 = uicontrol('Parent',FigureHandle, ...
                ...
                'String','Current', ...
                'Style','pushbutton');
            Button6Callback = 'FigureHandles = findobj(''Parent'', 0); PatchHandles = findobj(FigureHandles, ''Type'', ''patch''); propedit(PatchHandles,''v6''); drawnow';
