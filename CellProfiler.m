...
function ReportBugs_Callback(hObject, eventdata, handles)
 ...
 'Units','characters',...
 'BackgroundColor',[0.7 0.7 0.9],...
 'Callback','setpref(''Internet'',''SMTP_Server'',''mail'');fig=guidata(gcf);sendmail(''cellprofiler@csail.mit.edu'',get(fig.MailSubject,''String''),get(fig.MailBody,''String''));',...
 'CData',[],...
 'FontName','Times',...
 'FontSize',9.99999999999999,...
 'FontWeight','bold',...
...
'FontSize',font,...
'FontName','Times',...
'Position',[56.166666666667 26.5833333333333 21.6666666666667 2.08333333333333],...
'String','Object Identification',...
'Style','text',...
