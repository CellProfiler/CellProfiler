    ...
    while 1;
        ...
        elseif strncmp(output,'%pathnametextVAR',16) && OptionInCode == SelectedOption
            ...
            handles.BrowseButton{ModuleNums}(lastVariableCheck) = uicontrol(...
                ...
                'Units','pixels',...
                'BackgroundColor',[.7 .7 .9],...
                'Callback','handles=guidata(findobj(''tag'',''figure1'')); pathname = uigetdir(fullfile(handles.Current.DefaultOutputDirectory,''*.*''),''Pick the directory you want.'');UserData=get(gco,''UserData'');set(UserData{1},''string'',pathname);handles.Settings.VariableValues{UserData{2},UserData{3}}=pathname;guidata(handles.figure1,handles);clear UserData handles pathname;',...
                'FontName','helvetica',...
                'FontSize',handles.Current.FontSize,...
                'FontWeight','bold',...
...
listboxcallback = 'ToolsHelpWindowHandle = findobj(''tag'',''ToolsHelpWindow''); if (strcmpi(get(ToolsHelpWindowHandle,''SelectionType''),''open'')==1) toolsbox = findobj(''tag'',''toolsbox''); global toolsChoice; toolsChoice = get(toolsbox,''value''); close(ToolsHelpWindowHandle); clear toolsbox; end; clear ToolsHelpWindowHandle';
toolsbox = uicontrol(...
    'Parent',ToolsHelpWindowHandle,...
    'Units','normalized',...
    'backgroundColor',Color,...
...
AddModuleWindow = figure(...
    ...
    'NumberTitle','off',...
    'PaperPosition',get(0,'defaultfigurePaperPosition'),...
    'Position',[pos1(1)+pos2(1)+pos2(3) pos1(2)+pos2(2) 134.5 26.5],...
    'Resize','off',...
    'HandleVisibility','callback',...
    'Tag','AddModuleWindow',...
    'UserData',[],...
...
ButtonPanel = uipanel(...
    ...
    'Units','characters',...
    'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
    'Position',[1.75 1 130 4.5],...
    'Tag','HelpPanel',...
    'CreateFcn', {@local_CreateFcn, '', appdata} );

AddModuleWindowHandles.ButtonPanel = ButtonPanel;
...
appdata = [];
appdata.lastValidTag = 'FileProcessingListBox';

AddModuleWindowHandles.FileProcessingListBox = uicontrol(...
    'Parent',AddModuleWindow,...
    'Units','characters',...
    'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
    'Callback','fig=guidata(gcf);set(fig.PreProcessingListBox,''Value'',[]);set(fig.MeasurementListBox,''Value'',[]);set(fig.ObjectProcessingListBox,''Value'',[]);set(fig.OtherListBox,''Value'',[]);val=get(fig.FileProcessingListBox,''Value'');if (~isempty(val)); set(fig.FileProcessingListBox,''Value'',val(1));end;CellProfiler(''AddModuleListBox_Callback'',gcbo,[],guidata(gcf));clear val fig',...
    'FontSize',font,...
    'FontName','Helvetica',...
    'Interruptible','off',...
    'Max',2,...
    'Position',[3.166666666666 6.5 22.8333333333333 17],...
    'String',{  'Listbox' },...
    'Style','listbox',...
    'Value',1,...
    'Tag','FileProcessingListBox',...
    'Behavior',get(0,'defaultuicontrolBehavior'));
...
AddModuleWindowHandles.PreProcessingListBox = uicontrol(...
    ...
    'Units','characters',...
    'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
    'Callback','fig=guidata(gcf);set(fig.FileProcessingListBox,''Value'',[]);set(fig.MeasurementListBox,''Value'',[]);set(fig.ObjectProcessingListBox,''Value'',[]);set(fig.OtherListBox,''Value'',[]);val=get(fig.PreProcessingListBox,''Value'');if (~isempty(val)); set(fig.PreProcessingListBox,''Value'',val(1));end;CellProfiler(''AddModuleListBox_Callback'',gcbo,[],guidata(gcf));clear val fig',...
    'FontSize',font,...
    'FontName','Helvetica',...
    'Interruptible','off',...
    'Max',2,...
    'Position',[29.16666666666 6.5 22.8333333333333 17],...
    'String',{  'Listbox' },...
    'Style','listbox',...
    'Value',1,...
...
appdata = [];
appdata.lastValidTag = 'ObjectProcessingListBox';

AddModuleWindowHandles.ObjectProcessingListBox = uicontrol(...
    'Parent',AddModuleWindow,...
    'Units','characters',...
    'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
    'Callback','fig=guidata(gcf);set(fig.FileProcessingListBox,''Value'',[]);set(fig.PreProcessingListBox,''Value'',[]);set(fig.MeasurementListBox,''Value'',[]);set(fig.OtherListBox,''Value'',[]);val=get(fig.ObjectProcessingListBox,''Value'');if (~isempty(val)); set(fig.ObjectProcessingListBox,''Value'',val(1));end;CellProfiler(''AddModuleListBox_Callback'',gcbo,[],guidata(gcf));clear val fig',...
    'FontSize',font,...
    'FontName','Helvetica',...
    'Interruptible','off',...
    'Max',2,...
    'Position',[55.166666666666 6.5 22.8333333333333 17],...
    'String',{  'Listbox' },...
    'Style','listbox',...
    'Value',1,...
    'Tag','ObjectProcessingListBox',...
    'Behavior',get(0,'defaultuicontrolBehavior'));
...
AddModuleWindowHandles.MeasurementListBox = uicontrol(...
    ...
    'Units','characters',...
    'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
    'Callback','fig=guidata(gcf);set(fig.FileProcessingListBox,''Value'',[]);set(fig.PreProcessingListBox,''Value'',[]);set(fig.ObjectProcessingListBox,''Value'',[]);set(fig.OtherListBox,''Value'',[]);val=get(fig.MeasurementListBox,''Value'');if (~isempty(val));  set(fig.MeasurementListBox,''Value'',val(1));end;CellProfiler(''AddModuleListBox_Callback'',gcbo,[],guidata(gcf));clear val fig',...
    'FontSize',font,...
    'FontName','Helvetica',...
    'Interruptible','off',...
    'Max',2,...
    'Position',[81.16666666666 6.5 22.8333333333333 17],...
    'String',{  'Listbox' },...
    'Style','listbox',...
    'Value',1,...
...
AddModuleWindowHandles.OtherListBox = uicontrol(...
    ...
    'Units','characters',...
    'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
    'Callback','fig=guidata(gcf);set(fig.FileProcessingListBox,''Value'',[]);set(fig.PreProcessingListBox,''Value'',[]);set(fig.MeasurementListBox,''Value'',[]);set(fig.ObjectProcessingListBox,''Value'',[]);val=get(fig.OtherListBox,''Value'');if (~isempty(val)); set(fig.OtherListBox,''Value'',val(1));end;CellProfiler(''AddModuleListBox_Callback'',gcbo,[],guidata(gcf));clear val fig',...
    'FontSize',font,...
    'FontName','Helvetica',...
    'Interruptible','off',...
    'Max',2,...
    'Position',[107.16666666666 6.5 22.8333333333333 17],...
    'String',{  'Listbox' },...
    'Style','listbox',...
    'Value',1,...
    'Tag','OtherListBox',...
...
appdata = [];
appdata.lastValidTag = 'FileProcessingText';

AddModuleWindowHandles.FileProcessingText = uicontrol(...
    'Parent',AddModuleWindow,...
    'Units','characters',...
    'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
    'FontSize',font,...
    'FontName','Helvetica',...
    'Max',2,...
    'Position',[4.166666666667 23.5 21.6666666666667 1.5],...
    'String','File Processing',...
    'Style','text',...
    'Tag','FileProcessingText',...
    'Behavior',get(0,'defaultuicontrolBehavior'),...
    'CreateFcn', {@local_CreateFcn, '', appdata} );
...
AddModuleWindowHandles.PreProcessingText = uicontrol(...
    ...
    'FontSize',font,...
    'FontName','Helvetica',...
    'Position',[30.166666666666 23.5 21.6666666666667 1.5],...
...
appdata = [];
appdata.lastValidTag = 'ObjectProcessingText';

AddModuleWindowHandles.ObjectProcessingText = uicontrol(...
    'Parent',AddModuleWindow,...
    'Units','characters',...
    'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
    'FontSize',font,...
    'FontName','Helvetica',...
    'Position',[56.16666666666 23.5 21.6666666666667 1.5],...
    'String','Object Processing',...
    'Style','text',...
    'Tag','ObjectProcessingText',...
    'Behavior',get(0,'defaultuicontrolBehavior'),...
    'CreateFcn', {@local_CreateFcn, '', appdata} );

appdata = [];
appdata.lastValidTag = 'HelpObjectProcessingButton';

AddModuleWindowHandles.HelpObjectProcessingButton = uicontrol(...
    'Parent',AddModuleWindow,...
    'Units','pixels',...
    'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
    'Callback','CPtextdisplaybox(help(''HelpObjectProcessing.m''),''Object Processing Help'');',...
    'FontSize',font,...
    'FontName','Helventica',...
    'FontWeight','bold',...
    'Position',[382 310 12 25],...
    'String','?',...
    'Tag','HelpObjectProcessingButton',...
    'Behavior',get(0,'defaultuicontrolBehavior'),...
    'CreateFcn', {@local_CreateFcn, '', appdata} );
...
AddModuleWindowHandles.MeasurementModulesText = uicontrol(...
    ...
    'FontSize',font,...
    'FontName','Helvetica',...
    'Position',[82.166666666667 23.5 21.6666666666667 1.5],...
    'String','Measurement',...
    'Style','text',...
...
AddModuleWindowHandles.OtherModulesText = uicontrol(...
    ...
    'FontSize',font,...
    'FontName','Helvetica',...
    'Position',[108.16666666667 23.5 21.6666666666667 1.5],...
    'String','Other',...
    'Style','text',...
...
set(AddModuleWindowHandles.FileProcessingListBox,'String',FileProcessingFiles,...
    'Value',[])
