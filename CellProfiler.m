...
'FontSize',font,...
'FontName','Times',...
'Position',[54 29 21.6666666666667 2.4],...
...
appdata = [];
appdata.lastValidTag = 'HelpButtonOI';

AddModuleWindowHandles.HelpButtonOI = uicontrol(...
'Parent',AddModuleWindow,...
'Units','characters',...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'Callback','CellProfiler(''HelpButtonOI_Callback'',gcbo,[],guidata(gcf))',...
'FontSize',font,...
'FontName','Times',...
'Position',[73 29 4 2.4],...
'String','?',...
'Tag','HelpButtonOI',...
'Behavior',get(0,'defaultuicontrolBehavior'),...
'CreateFcn', {@local_CreateFcn, '', appdata} );
...
% hObject    handle to PixelSizeHelp (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
'Parent',h15,...
'BackgroundColor',[0.699999988079071 0.699999988079071 0.899999976158142],...
'Callback','CellProfiler(''AnalyzeImagesHelp_Callback'',gcbo,[],guidata(gcbo))',...
'FontWeight','bold',...
...
'String',{  'Default image'; 'directory:' },...
'Style','text',...
...
'Parent',h15,...
'BackgroundColor',[0.699999988079071 0.699999988079071 0.899999976158142],...
'Callback','CellProfiler(''DefaultImageDirectoryHelp_Callback'',gcbo,[],guidata(gcbo))',...
'FontWeight','bold',...
...
'Parent',h15,...
'BackgroundColor',[0.699999988079071 0.699999988079071 0.899999976158142],...
'Callback','CellProfiler(''DefaultOutputDirectoryHelp_Callback'',gcbo,[],guidata(gcbo))',...
'FontWeight','bold',...
...
'Parent',h15,...
'BackgroundColor',[0.699999988079071 0.699999988079071 0.899999976158142],...
'Callback','CellProfiler(''PixelSizeHelp_Callback'',gcbo,[],guidata(gcbo))',...
'FontWeight','bold',...
