...
StripPipelineText = uicontrol(...
    ...
    'String','If you uncheck this box you will run in diagnostic mode, where all the intermediate images and calculations for the most recent image cycle are saved in the output file, which drastically increases the output file size. Check this box if you would instead like to run in normal mode, producing smaller output files:',...
    'Style','text');
