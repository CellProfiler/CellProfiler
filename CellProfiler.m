...
h17 = uicontrol(...
    'Parent',h15,...
    'BackgroundColor',[0.699999988079071 0.699999988079071 0.899999976158142],...
    'Callback','handles = guidata(findobj(''tag'',''figure1''));for i = 1:length(handles.Current.HelpFilenames), if strfind(handles.Current.HelpFilenames{i},''HelpAnalyzeImages''), Option = i;end,end,if ~isempty(Option),CPtextdisplaybox(handles.Current.Help{Option-1},''CellProfiler Help'');end;clear ans handles Option i;',...
    'FontWeight','bold',...
...
h21 = uicontrol(...
    'Parent',h15,...
    'BackgroundColor',[0.699999988079071 0.699999988079071 0.899999976158142],...
    'Callback','handles = guidata(findobj(''tag'',''figure1''));for i = 1:length(handles.Current.HelpFilenames), if strfind(handles.Current.HelpFilenames{i},''HelpDefaultImageDirectory''), Option = i;end,end,if ~isempty(Option),CPtextdisplaybox(handles.Current.Help{Option-1},''Default Image Directory Help'');end;clear ans handles Option i;',...
    'FontWeight','bold',...
...
h28 = uicontrol(...
    'Parent',h15,...
    'BackgroundColor',[0.699999988079071 0.699999988079071 0.899999976158142],...
    'Callback','handles = guidata(findobj(''tag'',''figure1''));for i = 1:length(handles.Current.HelpFilenames), if strfind(handles.Current.HelpFilenames{i},''HelpDefaultOutputDirectory''), Option = i;end,end,if ~isempty(Option),CPtextdisplaybox(handles.Current.Help{Option-1},''Default Output Directory Help'');end;clear ans handles Option i;',...
    'FontWeight','bold',...
