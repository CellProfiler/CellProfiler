...
if strcmp(get(gcf,'SelectionType'),'open')
    ...
    if(get(AddModuleWindowHandles.FileHandlingListBox,'Value')~=1)
    ...
    elseif(get(AddModuleWindowHandles.PreProcessingListBox,'Value')~=1)
    ...
    elseif(get(AddModuleWindowHandles.ObjectIdentificationListBox,'Value')~=1)
    ...
    elseif(get(AddModuleWindowHandles.MeasurementListBox,'Value')~=1)
    ...
    elseif(get(AddModuleWindowHandles.OtherListBox,'Value')~=1)
...
'Position',[103.8 28.7948717948718 134.5 30.6666666666667],...
'Resize','off',...
...
'Units','characters',...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'Callback','fig=guidata(gcf);set(fig.PreProcessingListBox,''Value'',1);set(fig.MeasurementListBox,''Value'',1);set(fig.ObjectIdentificationListBox,''Value'',1);set(fig.OtherListBox,''Value'',1);CellProfiler(''AddModuleListBox_Callback'',gcbo,[],guidata(gcf))',...
'FontSize',10,...
'Position',[.25 .25 22.8333333333333 17],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'Units','characters',...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'Callback','fig=guidata(gcf);set(fig.FileHandlingListBox,''Value'',1);set(fig.MeasurementListBox,''Value'',1);set(fig.ObjectIdentificationListBox,''Value'',1);set(fig.OtherListBox,''Value'',1);CellProfiler(''AddModuleListBox_Callback'',gcbo,[],guidata(gcf))',...
'FontSize',10,...
'Position',[28.416666666666 .25 22.8333333333333 17],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'Units','characters',...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'Callback','fig=guidata(gcf);set(fig.FileHandlingListBox,''Value'',1);set(fig.PreProcessingListBox,''Value'',1);set(fig.MeasurementListBox,''Value'',1);set(fig.OtherListBox,''Value'',1);CellProfiler(''AddModuleListBox_Callback'',gcbo,[],guidata(gcf))',...
'FontSize',10,...
'Position',[54.4166666666666 .25 22.8333333333333 17],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'Units','characters',...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'Callback','fig=guidata(gcf);set(fig.FileHandlingListBox,''Value'',1);set(fig.PreProcessingListBox,''Value'',1);set(fig.ObjectIdentificationListBox,''Value'',1);set(fig.OtherListBox,''Value'',1);CellProfiler(''AddModuleListBox_Callback'',gcbo,[],guidata(gcf))',...
'FontSize',10,...
'Position',[80.416666666666 .25 22.8333333333333 17],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'Units','characters',...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'Callback','fig=guidata(gcf);set(fig.FileHandlingListBox,''Value'',1);set(fig.PreProcessingListBox,''Value'',1);set(fig.MeasurementListBox,''Value'',1);set(fig.ObjectIdentificationListBox,''Value'',1);CellProfiler(''AddModuleListBox_Callback'',gcbo,[],guidata(gcf))',...
'FontSize',10,...
'Position',[106.416666666666 .25 22.8333333333333 17],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'FontSize',10,...
'Position',[2.75 18.5833333333333 21.6666666666667 2.08333333333333],...
'String','File Handling Modules',...
'Style','text',...
...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'FontSize',10,...
'Position',[28.4166666666666 18.5833333333333 21.6666666666667 2.08333333333333],...
'String','Pre-Processing Modules',...
'Style','text',...
...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'FontSize',10,...
'Position',[54.4166666666667 18.5833333333333 21.6666666666667 2.08333333333333],...
'String','Object Identification Modules',...
'Style','text',...
...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'FontSize',10,...
'Position',[80.4166666666667 18.5833333333333 21.6666666666667 2.08333333333333],...
...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'FontSize',10,...
'Position',[106.416666666667 18.5833333333333 21.6666666666667 2.08333333333333],...
'String','Other Modules',...
'Style','text',...
...
'BackgroundColor',[0.701960784313725 0.701960784313725 0.901960784313726],...
'FontSize',10,...
'Position',[19 4 40 2.08333333333333],...
'String','Help',...
'Style','text',...
'Tag','DirectoryText',...
'Behavior',get(0,'defaultuicontrolBehavior'),...
...
FileHandlingFiles ={'Double Click To Add'};
PreProcessingFiles={'Double Click To Add'};
ObjectIdentificationFiles={'Double Click To Add'};
MeasurementFiles={'Double Click To Add'};
OtherFiles={'Double Click To Add'};
for i=1:length(dir_struct)
    if file_in_category(dir_struct(i).name, 'File Handling')
        FileHandlingFiles(length(FileHandlingFiles)+1)=cellstr(dir_struct(i).name);
    elseif file_in_category(dir_struct(i).name, 'Pre-processing')
        PreProcessingFiles(length(PreProcessingFiles)+1)=cellstr(dir_struct(i).name);
    elseif file_in_category(dir_struct(i).name, 'Object Identification')
        ObjectIdentificationFiles(length(ObjectIdentificationFiles)+1)=cellstr(dir_struct(i).name);
    elseif file_in_category(dir_struct(i).name, 'Measurement')
          MeasurementFiles(length(MeasurementFiles)+1)=cellstr(dir_struct(i).name);
    else
          OtherFiles(length(OtherFiles)+1)=cellstr(dir_struct(i).name);
    end 
end
