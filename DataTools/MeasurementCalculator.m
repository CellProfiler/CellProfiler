...
uicontrol(Window,'style','text','String','Calculate','FontName','Times','Fontweight','bold',...
    'Fontsize',10,'units','inches','position',[0 BaseY Width uiheight],'backgroundcolor',[.7 .7 .9]);

%%% FEATURE 1
BaseY = 2.7;
uicontrol(Window,'style','pushbutton','String','Get feature','FontName','Times','Fontsize',8,'units','inches',...
    'position',[0.1 BaseY 0.7 uiheight],'Callback',...
    ['[cobj,cfig] = gcbo;',...
    'UserData = get(cfig,''UserData'');',...
    '[ObjectTypename,FeatureType,FeatureNo] = CPgetfeature(UserData.handles);',...
...
uicontrol(Window,'style','text','String','Feature:','FontName','Times','Fontweight','bold','horizontalalignment','left',...
    'Fontsize',8,'units','inches','position',[0.1 BaseY+uiheight 1 uiheight],'backgroundcolor',[.7 .7 .9]);
...
uicontrol(Window,'style','text','String','Enter description and where to save:','FontName','Times','Fontweight','bold','horizontalalignment','left',...
    'Fontsize',8,'units','inches','position',[0.1 BaseY+uiheight 3.5 uiheight],'backgroundcolor',[.7 .7 .9]);
FeatureDescription = uicontrol(Window,'style','edit','string','Default measurement description','FontName','Times','FontSize',8,...
...
uicontrol(Window,'style','text','String','handles.Measurements.','FontName','Times','horizontalalignment','left',...
    'Fontsize',8,'units','inches','position',[0.1 BaseY-uiheight-0.05 1.5 uiheight],'backgroundcolor',[.7 .7 .9]);
SaveLocation = uicontrol(Window,'Style','popupmenu','string',{'',''},'FontName','Times','FontSize',8,...
...
uicontrol(Window,'style','text','String','.UserDefined','FontName','Times','horizontalalignment','left',...
    'Fontsize',8,'units','inches','position',[2.15 BaseY-uiheight-0.05 1 uiheight],'backgroundcolor',[.7 .7 .9]);

%%% EXPORT AND CANCEL BUTTONS
posx = (Width - 1.7)/2;               % Centers buttons horizontally
calculatebutton = uicontrol(Window,'style','pushbutton','String','Calculate','FontName','Times','FontSize',8,'units','inches',...
...
uicontrol(Window,'style','pushbutton','String','Cancel','FontName','Times','FontSize',8,'units','inches',...
