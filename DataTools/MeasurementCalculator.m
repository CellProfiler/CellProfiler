...
%%% FEATURE 1
BaseY = 2.7;
uicontrol(Window,'style','pushbutton','String','Get feature','FontName','Times','FontSize',handles.Preferences.FontSize,'units','inches',...
...
FeatureDescription = uicontrol(Window,'style','edit','string','Default measurement description','FontName','Times','FontSize',handles.Preferences.FontSize,...
...
SaveLocation = uicontrol(Window,'Style','popupmenu','string',{'',''},'FontName','Times','FontSize',handles.Preferences.FontSize,...
...
calculatebutton = uicontrol(Window,'style','pushbutton','String','Calculate','FontName','Times','FontSize',handles.Preferences.FontSize,'units','inches',...
...
uicontrol(Window,'style','pushbutton','String','Cancel','FontName','Times','FontSize',handles.Preferences.FontSize,'units','inches',...
