...
% format using this tool, or for measurements where there is one value
% per image, these data points can be viewed for all images.  As
% prompted, select the output file
