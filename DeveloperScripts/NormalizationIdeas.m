% Some work has been done to make a CellProfiler tool to aid in
% correcting data for spatial patterns. The following describes some of the
% issues that pertain to this task:
%
% NORMALIZATION:
