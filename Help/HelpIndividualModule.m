...
% Choose image analysis modules to add to your pipeline by clicking '+'.
% Typically, the first module which must be run is the Load Images module,
% where you specify the identity of the images that you want to analyze.
% Modules are added to the end of the pipeline, but their order can be
