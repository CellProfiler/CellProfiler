...
% $Revision$
    ...
    'Name','Save Image',...
    'NumberTitle','off',...
    'Position',[MainWinPos(1)+MainWinPos(3)/3 MainWinPos(2) MainWinPos(3)*1/2 MainWinPos(4)*2/3],...
    'Resize','off',...
    'HandleVisibility','on',...
    'Tag','SaveImageHandle',...
    'UserData',userData);
    ...
    'Position',[0.1 0.92 0.6 0.07],...
    'String','What would you like to call the file?',...
    'Style','text');
    ...
    SaveFunction = ...
        ...
        'else,'...
            ...
            'try,'...
                ...
                'CPmsgbox(''The picture was sucessfully saved'');'...
            'catch,'...
                'CPmsgbox(''For some reason, the picure was unable to save'');'...
            'end,'...
