...
'Position',[9.8 12.9230769230769 30.2 15.4615384615385],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'Position',[49.8 12.9230769230769 30.2 15.4615384615385],...
'String',{  'Listbox' },...
'Style','listbox',...
'Value',1,...
...
'Parent',h1,...
'Units','characters',...
'Position',[9.8 29.1538461538462 30.2 1.76923076923077],...
...
'Parent',h1,...
'Units','characters',...
'Position',[49.8 29.1538461538462 30.2 1.76923076923077],...
...
'String','Do you want to try to load the saved or default variables?',...
'Style','text',...
'Tag','text3',...
'Behavior',get(0,'defaultuicontrolBehavior'),...
'CreateFcn', {@local_CreateFcn, '', appdata} );
