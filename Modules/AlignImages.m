...
%textVAR1 = What did you call the first image to be aligned?
%defaultVAR1 = OrigBlue
fieldname = ['Vvariable',CurrentAlgorithm,'_01'];
Image1Name = handles.(fieldname);
%textVAR2 = What do you want to call the aligned first image?
%defaultVAR2 = AlignedBlue
fieldname = ['Vvariable',CurrentAlgorithm,'_02'];
AlignedImage1Name = handles.(fieldname);
%textVAR3 = To save the adjusted first image, enter text to append to the image name 
%defaultVAR3 = N
fieldname = ['Vvariable',CurrentAlgorithm,'_03'];
SaveImage1 = handles.(fieldname);
%textVAR4 = What did you call the second image to be aligned?
%defaultVAR4 = OrigGreen
fieldname = ['Vvariable',CurrentAlgorithm,'_04'];
Image2Name = handles.(fieldname);
%textVAR5 = What do you want to call the aligned second image?
%defaultVAR5 = AlignedGreen
fieldname = ['Vvariable',CurrentAlgorithm,'_05'];
AlignedImage2Name = handles.(fieldname);
%textVAR6 = To save the adjusted second image, enter text to append to the image name 
%defaultVAR6 = N
fieldname = ['Vvariable',CurrentAlgorithm,'_06'];
SaveImage2 = handles.(fieldname);
%textVAR7 = What did you call the third image to be aligned?
%defaultVAR7 = /
fieldname = ['Vvariable',CurrentAlgorithm,'_07'];
Image3Name = handles.(fieldname);
%textVAR8 = What do you want to call the aligned third image?
%defaultVAR8 = /
fieldname = ['Vvariable',CurrentAlgorithm,'_08'];
AlignedImage3Name = handles.(fieldname);
%textVAR9 = To save the adjusted third image, enter text to append to the image name 
%defaultVAR9 = N
