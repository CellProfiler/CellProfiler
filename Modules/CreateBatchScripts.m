...
if strcmp(BatchCellProfilerPath, '/') == 1,
    BatchCellProfilerPath = handles.Vdefaultalgorithmdirectory;
end
...
if (CurrentAlgorithmNum ~= handles.numAlgorithms),
...
for n = 2:BatchSize:handles.Vnumberimagesets,
    ...
    fprintf(BatchFile, '            handles.currentalgorithm = AlgNumberAsString;\n');
