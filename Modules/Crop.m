...
%textVAR1 = What did you call the image to be cropped?
%defaultVAR1 = OrigBlue
fieldname = ['Vvariable',CurrentAlgorithm,'_01'];
ImageName = handles.(fieldname);
%textVAR2 = What do you want to call the cropped image?
%defaultVAR2 = CropBlue
fieldname = ['Vvariable',CurrentAlgorithm,'_02'];
CroppedImageName = handles.(fieldname);
%textVAR3 = To save the adjusted image, enter text to append to the image name 
%defaultVAR3 = N
...
%textVAR6 = For rectangular cropping, type R. For a shape from a file, type F
%defaultVAR6 = R
%textVAR7 = To draw an ellipse on each image, type EE; draw one ellipse for all images: EA
fieldname = ['Vvariable',CurrentAlgorithm,'_06'];
Shape = upper(handles.(fieldname));
%textVAR8 = Rectangular: enter the pixel position for the left (X), top (Y) corner (with comma between)
%defaultVAR8 = 1,1
fieldname = ['Vvariable',CurrentAlgorithm,'_08'];
LeftTop = handles.(fieldname);
%textVAR9 = Rectangular: enter the pixel position for the right (X), bottom (Y) corner (with comma)
%defaultVAR9 = 100,100
fieldname = ['Vvariable',CurrentAlgorithm,'_09'];
RightBottom = handles.(fieldname);
...
BinaryCropImageName = handles.(fieldname);
