function handles = IdentifyPrimAdaptThreshold(handles)
...
%
% Method C: the optimal thresholds are determined using the isodata
% algorithm, for distinct blocks across the image.  The resulting
% thresholds are blurred.
%
% Settings:
...
% Smaller block sizes take more processing time.
%
% Module C: the optimal thresholds are determined by determining the
...
%AskOptionSelect
%OptionList01 = Method A
%OptionList02 = Method B
%OptionList03 = Method C
%OptionList04 = Method D
%Question = Which algorithm?

CurrentModule = handles.Current.CurrentModuleNumber;
CurrentModuleNum = str2double(CurrentModule);
SelectedOption = handles.Settings.SelectedOption(CurrentModuleNum);

if SelectedOption == 1
    handles = IdentifyPrimAdaptThresholdA(handles);
elseif SelectedOption == 2
    handles = IdentifyPrimAdaptThresholdB(handles);
elseif SelectedOption == 3
    handles = IdentifyPrimAdaptThresholdC(handles);
elseif SelectedOption == 4
    handles = IdentifyPrimAdaptThresholdD(handles);
end
...
%defaultVAR05 = 31
NeighborhoodSize = str2double(char(handles.Settings.VariableValues{CurrentModuleNum,5}));

%textVAR06 = Enter sigma (positive number, higher = less stringent)
%defaultVAR06 = 20
Sigma = str2double(char(handles.Settings.VariableValues{CurrentModuleNum,6}));
