...
%
% See also IDENTIFYPRIMADAPTTHRESHOLDB,
...
CurrentOptionSelect = handles.Settings.OptionSelect(CurrentModule);

%AskOptionSelect
%OptionList01 = Otsu's Algorithm
%OptionList02 = Intensity Average Algorithm
%OptionList03 = Isodata Algorithm
%OptionList04 = Gaussian Lowpass Algorithm
...
%The function below is only used for Isodata Algorithm
