...
%textVAR6 = Set the Maxima Suppression Neighborhood (Non-negative integer, Default = 6):
%defaultVAR6 = 6
fieldname = ['Vvariable',CurrentAlgorithm,'_06'];
MaximaSuppressionNeighborhood = str2num(handles.(fieldname));
%textVAR7 = Set the blur radius (Lower is faster; Non-negative number; Default = 3):
%defaultVAR7 = 3
