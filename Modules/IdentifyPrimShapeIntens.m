function handles = AlgIdentifyPrimShapeIntens(handles)
...
% 
% 
% The Original Code is the the Identify Primary Shape Intensity module.
% 
...
%%% Checks whether the image exists in the handles structure.
    ...
    error(['Image processing has been canceled. Prior to running the Identify Primary Shape Intensity module, you must have previously run a module to load an image. You specified in the Identify Primary Shape Intensity module that this image was called ', ImageName, ' which should have produced a field in the handles structure called ', ImageName, '. The Identify Primary Shape Intensity module cannot find this image.']);
    end
...
if ndims(OrigImageToBeAnalyzed) ~= 2
    error('Image processing was canceled because the Identify Primary Shape Intensity module requires an input image that is two-dimensional (i.e. X vs Y), but the image loaded does not fit this requirement.  This may be because the image is a color image.')
end
