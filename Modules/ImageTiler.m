...
%textVAR1 = What did you call the images to be tiled?
%defaultVAR1 = OrigBlue
fieldname = ['Vvariable',CurrentAlgorithm,'_01'];
ImageName = handles.(fieldname);
%textVAR2 = What do you want to call the tiled image?
%defaultVAR2 = TiledImage
fieldname = ['Vvariable',CurrentAlgorithm,'_02'];
TiledImageName = handles.(fieldname);
%textVAR3 = Number of rows to display (leave "A" to calculate automatically)
%defaultVAR3 = A
fieldname = ['Vvariable',CurrentAlgorithm,'_03'];
NumberRows = handles.(fieldname);
%textVAR4 = Number of columns to display (leave "A" to calculate automatically)
%defaultVAR4 = A
fieldname = ['Vvariable',CurrentAlgorithm,'_04'];
NumberColumns = handles.(fieldname);
%textVAR5 = Are the first two images arranged in a row or a column?
%defaultVAR5 = C
fieldname = ['Vvariable',CurrentAlgorithm,'_05'];
RowOrColumn = handles.(fieldname);
%textVAR6 = Is the first image at the bottom or the top?
%defaultVAR6 = T
fieldname = ['Vvariable',CurrentAlgorithm,'_06'];
TopOrBottom = handles.(fieldname);
%textVAR7 = Is the first image at the left or the right?
%defaultVAR7 = L
fieldname = ['Vvariable',CurrentAlgorithm,'_07'];
LeftOrRight = handles.(fieldname);
%textVAR8 = What fraction should the images be sized (the resolution will be changed)?
%defaultVAR8 = .1
fieldname = ['Vvariable',CurrentAlgorithm,'_08'];
SizeChange = handles.(fieldname);
%textVAR9 = To save the resulting tiled image, enter a filename (no extension) 
%defaultVAR9 = N
