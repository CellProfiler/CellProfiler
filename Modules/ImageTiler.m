...
% window or in the wrong figure window, or in help dialog boxes.
    ...
    uicontrol('Style', 'pushbutton', ...
        ...
        'Callback', ShowGridButtonFunction, 'parent',ThisModuleFigureNumber,'FontSize',Font);
    HideGridButtonFunction = 'Handles = findobj(''type'',''line''); set(Handles,''visible'',''off''); clear Handles';
    uicontrol('Style', 'pushbutton', ...
        'String', 'Hide', 'Position', [60 6 45 20], ...
        'Callback', HideGridButtonFunction, 'parent',ThisModuleFigureNumber,'FontSize',Font);
    ...
    uicontrol('Style', 'pushbutton', ...
        ...
        'Callback', ShowFileNamesButtonFunction, 'parent',ThisModuleFigureNumber,'FontSize',Font);
    ...
    uicontrol('Style', 'pushbutton', ...
        ...
        'Callback', HideFileNamesButtonFunction, 'parent',ThisModuleFigureNumber,'FontSize',Font);
    ...
    ShowSampleInfoButtonFunction = 'Handles = findobj(''UserData'',''SampleInfoTextHandles''); if isempty(Handles) == 1, CPwarndlg(''No sample information was loaded.''), else set(Handles,''visible'',''on''); end, clear Handles';
    uicontrol('Style', 'pushbutton', ...
        'String', 'Show', 'Position', [330 6 45 20], ...
        'Callback', ShowSampleInfoButtonFunction, 'parent',ThisModuleFigureNumber,'FontSize',Font);
    HideSampleInfoButtonFunction = 'Handles = findobj(''UserData'',''SampleInfoTextHandles''); if isempty(Handles) == 1, CPwarndlg(''No sample information was loaded.''), else set(Handles,''visible'',''off''); end, clear Handles';
    uicontrol('Style', 'pushbutton', ...
        'String', 'Hide', 'Position', [380 6 45 20], ...
        'Callback', HideSampleInfoButtonFunction, 'parent',ThisModuleFigureNumber,'FontSize',Font);
    ChangeSampleInfoButtonFunction = 'Handles = findobj(''UserData'',''SampleInfoTextHandles''); if isempty(Handles) == 1, CPwarndlg(''No sample information was loaded.''), else propedit(Handles); end, clear Handles';
    uicontrol('Style', 'pushbutton', ...
        'String', 'Change', 'Position', [430 6 45 20], ...
        'Callback', ChangeSampleInfoButtonFunction, 'parent',ThisModuleFigureNumber,'FontSize',Font);
    ...
    uicontrol('Style', 'pushbutton', ...
        ...
        'Callback', FolderButtonFunction, 'parent',ThisModuleFigureNumber,'FontSize',Font);
    %%% Text1
