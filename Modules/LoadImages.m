...
% regular expressions to match text.
%
...
%   http://www.mathworks.com/access/helpdesk/help/techdoc/matlab_prog/f0-42
%   649.html
%  
...
%
%The files containing the text that are in image format will be loaded.
%CellProfiler can now open and read .ZVI files.  .ZVI files are Zeiss files that are
%generated by the microscope imaging software, Axiovision.  These images are
%stored with 12-bit precision.  Currently, this will not work with stacked
%or color images. 
%
