...
% Selecting this option with TEXT mode will examine the filenames for 
% unmatched or duplicate files based on the filename prefix (such as those 
% generated by HCS systems).  This setting is only functional if multiple
% channels are input, and does not check for files missing from a particular
% plate layout.  A dialog box will report the results. 
%
...
%textVAR17 = Do you want to check image sets for missing or duplicate files? This is functional only for multiple input channels.
%choiceVAR17 = No
%choiceVAR17 = Yes
