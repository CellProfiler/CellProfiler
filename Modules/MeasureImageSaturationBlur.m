...
for ImageNumber = 1:length(NameImageToCheck);
    ...
    fieldname = ['SaturationBlur_',NameImageToCheck{ImageNumber},'Features'];
	...
	handles = CPaddmeasurements(handles, 'Image', ...
				    [fieldname, '_FocusScore'], ...
				    FocusScore{ImageNumber});
	handles = CPaddmeasurements(handles, 'Image', ...
				    [fieldname, '_LocalFocusScore'], ...
				    LocalFocusScore{ImageNumber});
	handles = CPaddmeasurements(handles, 'Image', ...
				    [fieldname, '_LocalFocusScoreWindowSize'], ...
				    WindowSize);
    end
    handles = CPaddmeasurements(handles, 'Image', ...
				[fieldname, '_PercentSaturated'], ...
				PercentSaturation{ImageNumber});
    handles = CPaddmeasurements(handles, 'Image', ...
				[fieldname, '_PercentMaximal'], ...
