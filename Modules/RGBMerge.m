function handles = AlgRGBMerge2(handles)
...
%textVAR1 = What did you call the image to be colored blue?
%defaultVAR1 = OrigBlue
fieldname = ['Vvariable',CurrentAlgorithm,'_01'];
BlueImageName = handles.(fieldname);
%textVAR2 = What did you call the image to be colored green?
%defaultVAR2 = OrigGreen
fieldname = ['Vvariable',CurrentAlgorithm,'_02'];
GreenImageName = handles.(fieldname);
%textVAR3 = What did you call the image to be colored red?
%defaultVAR3 = OrigRed
fieldname = ['Vvariable',CurrentAlgorithm,'_03'];
RedImageName = handles.(fieldname);
%textVAR4 = Type "N" in any slots above to leave that color black.
%textVAR5 = What do you want to call the resulting image?
%defaultVAR5 = RGBImage
fieldname = ['Vvariable',CurrentAlgorithm,'_05'];
RGBImageName = handles.(fieldname);
%textVAR6 = Enter the adjustment factor for the blue image
%defaultVAR6 = 1
fieldname = ['Vvariable',CurrentAlgorithm,'_06'];
BlueAdjustmentFactor = handles.(fieldname);
%textVAR7 = Enter the adjustment factor for the green image
%defaultVAR7 = 1
fieldname = ['Vvariable',CurrentAlgorithm,'_07'];
GreenAdjustmentFactor = handles.(fieldname);
%textVAR8 = Enter the adjustment factor for the red image
%defaultVAR8 = 1
