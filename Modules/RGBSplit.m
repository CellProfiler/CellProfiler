...
%textVAR1 = What did you call the image to be split into black and white images?
%defaultVAR1 = OrigRGB
fieldname = ['Vvariable',CurrentAlgorithm,'_01'];
RGBImageName = handles.(fieldname);
%textVAR2 = What do you want to call the image that was red?
%defaultVAR2 = OrigRed
fieldname = ['Vvariable',CurrentAlgorithm,'_02'];
RedImageName = handles.(fieldname);
%textVAR3 = What do you want to call the image that was green?
%defaultVAR3 = OrigGreen
fieldname = ['Vvariable',CurrentAlgorithm,'_03'];
GreenImageName = handles.(fieldname);
%textVAR4 = What do you want to call the image that was blue?
%defaultVAR4 = OrigBlue
fieldname = ['Vvariable',CurrentAlgorithm,'_04'];
BlueImageName = handles.(fieldname);
%textVAR5 = Type "N" in any slots above to ignore that color.
%textVAR6 = To save the red image, enter text to append to the image name
%defaultVAR6 = N
fieldname = ['Vvariable',CurrentAlgorithm,'_06'];
RedTextAppend = handles.(fieldname);
%textVAR7 = To save the green image, enter text to append to the image name
%defaultVAR7 = N
fieldname = ['Vvariable',CurrentAlgorithm,'_07'];
GreenTextAppend = handles.(fieldname);
%textVAR8 = To save the blue image, enter text to append to the image name
%defaultVAR8 = N
fieldname = ['Vvariable',CurrentAlgorithm,'_08'];
BlueTextAppend = handles.(fieldname);
%textVAR9 =  Otherwise, leave as "N".
