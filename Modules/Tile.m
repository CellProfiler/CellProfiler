...
if handles.Current.SetBeingAnalyzed == handles.Current.NumberOfImageSets
    ...
    if any(findobj == ThisModuleFigureNumber) == 1;
        ...
        HiResFunction = ['[Xcord,Ycord] = getpts;'...
            ...
            '    error(''You must choose at least two locations.'');'...
            'end,'...
            ...
            '    error(''You must choose two points within the same image!'');'...
            'end,'...
            '[Filename,Pathname] = uigetfile(fullfile(userData.MyHandles.Preferences.DefaultImageDirectory,''*.*''),[''Please open the image named: '',char(ImageName1)]);'...
        ...
        uicontrol('Style', 'pushbutton', ...
            'String', 'HI-RES', 'Position', [290 6 45 20], 'BackgroundColor',[.7 .7 .9],...
            'Callback',HiResFunction,'parent',ThisModuleFigureNumber,'FontSize',Font);
