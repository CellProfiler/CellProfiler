...
if handles.Current.SetBeingAnalyzed == handles.Current.NumberOfImageSets
    ...
    if any(findobj == ThisModuleFigureNumber)
        ...
        HiResFunction = ['[Xcord,Ycord] = getpts;'...
            ...
            'end,'...
            'try LoadedImage = imread(fullfile(userData.MyHandles.Preferences.DefaultImageDirectory,ImageName1)); catch disp(''that failed''), [Filename,Pathname] = uigetfile(fullfile(userData.MyHandles.Preferences.DefaultImageDirectory,''.'',''*.*''),[''Please open the image named: '',char(ImageName1)]); end,'...
            'pixelvalue = 1;'...
            'PreXImageNumber = 1;'...
            'while pixelvalue > 0,'...
