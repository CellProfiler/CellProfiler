...
class OmeroLoginDlg(wx.Dialog):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.server = cellprofiler.configuration.get_omero_server() or ""
        self.port = cellprofiler.configuration.get_omero_port()
        self.user = cellprofiler.configuration.get_omero_user() or ""
    ...
    def connect(self):
        ...
        try:
            ...
            self.port = port
            self.user = user
            cellprofiler.configuration.set_omero_server(server)
            cellprofiler.configuration.set_omero_port(port)
            cellprofiler.configuration.set_omero_user(user)
