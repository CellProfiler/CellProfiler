...
from cellprofiler.extensions.plugins import plugin_list
from cellprofiler.configuration import get_plugin_directory

# python extensions and their corresponding cellprofiler.module classes
...
# the builtin CP extensions that will be loaded from the cellprofiler.extensions directory
...
substitutions = {'Average': 'MakeProjection',
                 ...
                 'Combine': 'ImageMath',
                 'cellprofiler.extensions.converttoimage.ConvertToImage': 'ConvertObjectsToImage',
                 'ConvertToImage': 'ConvertObjectsToImage',
                 'CorrectIllumination_Apply': 'CorrectIlluminationApply',
                 'cellprofiler.extensions.correctillumination_apply.CorrectIllumination_Apply': 'CorrectIlluminationApply',
                 'CorrectIllumination_Calculate': 'CorrectIlluminationCalculate',
                 'cellprofiler.extensions.correctillumination_calculate.CorrectIllumination_Calculate': 'CorrectIlluminationCalculate',
                 'cellprofiler.extensions.enhanceorsuppressspeckles.EnhanceOrSuppressSpeckles': 'EnhanceOrSuppressFeatures',
                 'DifferentiateStains': 'UnmixColors',
                 'EnhanceOrSuppressSpeckles': 'EnhanceOrSuppressFeatures',
                 'Exclude': 'MaskObjects',
                 'cellprofiler.extensions.expandorshrink.ExpandOrShrink': 'ExpandOrShrinkObjects',
                 'ExpandOrShrink': 'ExpandOrShrinkObjects',
                 'ExportToExcel': 'ExportToSpreadsheet',
                 'cellprofiler.extensions.exporttoexcel.ExportToExcel': 'ExportToSpreadsheet',
                 'FilterByObjectMeasurement': 'FilterObjects',
                 'cellprofiler.extensions.filterbyobjectmeasurement.FilterByObjectMeasurement': 'FilterObjects',
                 'FindEdges': 'EnhanceEdges',
                 'cellprofiler.extensions.findedges.FindEdges': 'EnhanceEdges',
                 'FlagImageForQC': 'FlagImage',
                 'Flip': 'FlipAndRotate',
                 'IdentifyPrimManual': 'IdentifyObjectsManually',
                 'cellprofiler.extensions.identifyprimautomatic.IdentifyPrimAutomatic': 'IdentifyPrimaryObjects',
                 'IdentifyPrimAutomatic': 'IdentifyPrimaryObjects',
                 'cellprofiler.extensions.identifysecondary.IdentifySecondary': 'IdentifySecondaryObjects',
                 'IdentifySecondary': 'IdentifySecondaryObjects',
                 'cellprofiler.extensions.identifytertiarysubregion.IdentifyTertiarySubregion': 'IdentifyTertiaryObjects',
                 'IdentifyTertiarySubregion': 'IdentifyTertiaryObjects',
                 'cellprofiler.extensions.imageconvexhull.ImageConvexHull': 'Morph',
                 'ImageConvexHull': 'Morph',
                 'InvertIntensity': 'ImageMath',
                 'KeepLargestObject': 'FilterObjects',
                 'cellprofiler.extensions.loadtext.LoadText': 'LoadData',
                 'LoadText': 'LoadData',
                 'cellprofiler.extensions.measureimagegranularity.MeasureImageGranularity': 'MeasureGranularity',
                 'MeasureImageGranularity': 'MeasureGranularity',
                 'cellprofiler.extensions.measureobjectareashape.MeasureObjectAreaShape': 'MeasureObjectSizeShape',
                 ...
                 'cellprofiler.extensions.measureobjectradialdistribution.MeasureObjectRadialDistribution': 'MeasureObjectIntensityDistribution',
                 'Multiply': 'ImageMath',
                 'PlaceAdjacent': 'Tile',
                 'cellprofiler.extensions.relabelobjects.RelabelObjects': 'ReassignObjectNumbers',
                 'RelabelObjects': 'ReassignObjectNumbers',
                 'cellprofiler.extensions.relate.Relate': 'RelateObjects',
                 'Relate': 'RelateObjects',
                 'Rotate': 'FlipAndRotate',
                 'SmoothOrEnhance': 'Smooth',
                 'SmoothKeepingEdges': 'Smooth',
                 'cellprofiler.extensions.speedupcellprofiler.SpeedUpCellProfiler': 'ConserveMemory',
                 'SpeedUpCellProfiler': 'ConserveMemory',
                 'SplitIntoContiguousObjects': 'ReassignObjectNumbers',
                 'Subtract': 'ImageMath',
                 'UnifyObjects': 'ReassignObjectNumbers',
                 'cellprofiler.extensions.overlay_outlines.OverlayOutlines': 'OverlayOutlines',
                 'CorrectIllumination_Apply': 'CorrectIlluminationApply',
                 'CorrectIllumination_Calculate': 'CorrectIlluminationCalculate'
                 }
...
def fill_modules():
    ...
    for mod in builtin_modules:
        add_module('cellprofiler.extensions.' + mod, True)
    ...
    datatools.sort()
    if len(badmodules) > 0:
        logger.warning("could not load these extensions: %s",
