...
class CalculateImageOverlap(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.object_name_GT = cps.ObjectNameSubscriber(
            ...
            the result of another segmentation algorithm whose results you would like to compare. See the <b>Load</b> extensions for more details
            on loading objects.""")
