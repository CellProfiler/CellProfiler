...
class CorrectIlluminationCalculate(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.each_or_all = cps.Choice(
            ...
            extensions; using images produced by other extensions will yield an error.</li>
        ...
        self.save_average_image = cps.Binary(
            ...
            needed for downstream extensions. It can be helpful to retain it in case you wish to try several
        ...
        self.save_dilated_image = cps.Binary(
            ...
            It is an image produced during the calculations, and is not typically needed for downstream extensions.
    ...
    def validate_module(self, pipeline):
        ...
        if not pipeline.is_image_from_file(self.image_name.value) and self.each_or_all == EA_ALL_FIRST:
            raise cps.ValidationError(
                    "All: First cycle requires that the input image be provided by the Input extensions, or LoadImages/LoadData.",
                    self.each_or_all)
