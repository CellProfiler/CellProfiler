...
class CreateWebPage(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.wants_thumbnails = cps.Binary(
            ...
            them using the <b>Input</b> extensions; you can also run a separate
            pipeline prior to this one to create thumbnails from your originals
            using the <b>Resize</b> and <b>SaveImages</b> extensions. For some high-content
