...
# Doens't seem to like importing defs from cellprofiler.application.moduleview so define here
ABSOLUTE = "Absolute"
FROM_EDGE = "From edge"
...
class Crop(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.shape = cps.Choice(
            ...
            You will be able to select images that were generated by previous <b>Crop</b> extensions.
        ...
        self.use_plate_fix = cps.Binary(
            ...
            extensions (especially ones involving illumination correction). </p>
