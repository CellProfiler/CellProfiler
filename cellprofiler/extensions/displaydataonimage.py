...
from cellprofiler.extensions.identify import M_LOCATION_CENTER_X, M_LOCATION_CENTER_Y
...
class DisplayDataOnImage(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.display_image = cps.ImageNameProvider(
            ...
            subsequent extensions (such as <b>SaveImages</b>).""")
