...
class EditObjectsManually(I.Identify):
    ...
    def create_settings(self):
        ...
        self.wants_outlines = cps.Binary(
            ...
            can be saved by downstream extensions or overlayed on other images
        ...
        self.renumber_choice = cps.Choice(
            ...
            original objects and you only want to use the edited objects in downstream extensions; the
