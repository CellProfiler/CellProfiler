...
class FilterObjects(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.mode = cps.Choice(
            ...
            produced by upstream extensions in the pipeline.</li>
    ...
    def add_measurement(self, can_delete=True):
        ...
        group.append("measurement", cps.Measurement(
            ...
            See the <b>Measurements</b> extensions help pages
                ...
                if not any([mc[0] == r.object_name and
                    ...
                    raise cps.ValidationError(
                        ("The rules file, %s, uses the measurement, %s "
                         ...
                         "measurement extensions to produce the measurement.") %
