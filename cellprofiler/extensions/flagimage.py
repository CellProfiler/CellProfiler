    ...
    def add_flag(self, can_delete=True):
        ...
        group.append("wants_skip",
                     cps.Binary(
                        ...
                        that are flagged. CellProfiler will not run subsequent extensions in the
    ...
    def upgrade_settings(self, setting_values, variable_revision_number,
        ...
        if from_matlab and (variable_revision_number == 1 or variable_revision_number == 2):
            ...
            if new_or_append == "Append existing flag":
                logger.warning(
                        "CellProfiler 2.0 can't combine flags from multiple FlagImageForQC extensions imported from version 1.0")
