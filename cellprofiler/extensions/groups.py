...
from cellprofiler.application.help import PROTIP_RECOMEND_ICON, PROTIP_AVOID_ICON, TECH_NOTE_ICON, GROUPS_DISPLAY_TABLE
...
Some downstream extensions of CellProfiler are capable of processing groups of images in useful ways
...
Using this module assumes that you have already adjusted the following Input extensions:
<ul>
...
<ul>
<li>If no groups are defined, the Analysis extensions in the rest of the pipeline will be applied to all images in
