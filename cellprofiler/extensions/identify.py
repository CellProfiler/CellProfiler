...
class Identify(cellprofiler.extension.Extension):
    ...
    def create_threshold_settings(self, methods=TM_METHODS):
        ...
        self.threshold_scope = cps.Choice(
            ...
            extensions, such as <b>Morph</b>. Note that even though no algorithm is actually
            ...
            such as one of the <b>Measure</b> extensions, <b>ApplyThreshold</b> or
    ...
    def get_measurement_objects_name(self):
        ...
        Identify extensions and ApplyThreshold store measurements in the Image
...
def get_object_measurement_columns(object_name):
    '''Get the column definitions for measurements made by identify extensions

    Identify extensions can use this call when implementing
