...
If this is not the case, other extensions can be used to pre-process the images to ensure they are in
the proper form:
<ul>
...
A set of primary objects are produced by this module, which can be used in downstream extensions
...
from cellprofiler.application.help import HELP_ON_MEASURING_DISTANCES, RETAINING_OUTLINES_HELP, NAMING_OUTLINES_HELP
