...
A set of secondary objects are produced by this module, which can be used in downstream extensions
...
<p>See also the other <b>Identify</b> extensions.</p>
''' % globals()
...
class IdentifySecondaryObjects(cpmi.Identify):
    ...
    def create_settings(self):
        ...
        self.wants_discard_edge = cps.Binary(
            ...
            with respect to downstream measurement extensions, but they are retained in memory
            as "unedited objects"; this allows them to be considered in downstream extensions that modify the
        ...
        self.new_primary_objects_name = cps.ObjectNameProvider(
            ...
            "unedited object"; this allows them to be considered in downstream extensions that modify the
            segmentation.""")
