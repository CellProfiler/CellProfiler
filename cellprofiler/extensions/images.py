...
class Images(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.filter_choice = cps.Choice(
            ...
            panel downstream to have a meaningful name assigned to it (so other extensions can
            ...
            panel will be passed to downstream extensions for processing. This option can be
            ...
            extensions. The permissible image formats are provided by a library called Bio-Formats; see
    ...
    def change_causes_prepare_run(self, setting):
        ...
        will affect the image plane descriptors passed onto later extensions
...
class ImagePredicate(cps.Filter.FilterPredicate):
    ...
    class FakeModule(cpm.Extension):
