...
import cellprofiler.extension as cpmodule
...
class LoadImages(cpmodule.Extension):
    ...
    def add_channel(self, image_settings, can_remove=True):
        ...
        group.append("image_name", cps.FileImageNameProvider(
            ...
            that you can use to refer to these images in later extensions.  Keep
    ...
    def validate_module_warnings(self, pipeline):
        ...
        from cellprofiler.extensions.loaddata import LoadData
    ...
    def get_image_numbers_by_tags(self, workspace, tags):
        ...
        for tag in tags:
            if "_".join((cpmeas.C_METADATA, tag)) not in metadata_features:
                message = (
                    "LoadImages needs the prior Load extensions to define "
    ...
    def image_name_vars(self):
        """Return the list of values in the image name field (the name that later extensions see)
        """
        result = []
    ...
    def convert(self, pipeline, metadata, namesandtypes, groups):
        '''Convert to the modern format using the input extensions

        This method converts any LoadImages extensions in the pipeline to
        ...
        '''
        import cellprofiler.extensions.metadata as cpmetadata
        import cellprofiler.extensions.namesandtypes as cpnamesandtypes
        import cellprofiler.extensions.groups as cpgroups
