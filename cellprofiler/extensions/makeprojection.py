...
<p>This module will create a projection of all images specified in the Input extensions. For more
...
Keep in mind that the projection image is not immediately available in subsequent extensions because the
...
See also the help for the <b>Input</b> extensions.
''' % globals()
...
class MakeProjection(cpm.Extension):
