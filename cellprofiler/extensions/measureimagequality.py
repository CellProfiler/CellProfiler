...
class MeasureImageQuality(cpm.Extension):
    ...
    def create_settings(self):
        self.images_choice = cps.Choice(
            ...
            <ul>
            <li><i>%(O_ALL_LOADED)s:</i> Use all images loaded with the <b>Input</b> extensions.
    ...
    def add_image_group(self, can_remove=True):
        ...
        group.append("image_names", cps.ImageNameSubscriberMultiChoice(
            ...
            the images that were created by prior extensions.""" % globals()))
        ...
        group.append("include_image_scalings", cps.Binary(
            ...
            that loaded using the <b>Input</b> extensions. This is useful in confirming
    ...
    def add_threshold_group(self, image_group=None, can_remove=True):
        ...
        group.append("threshold_method", cps.Choice("Select a thresholding method",
            ...
            methods used in the <b>Identify</b> extensions. Only the global methods are applied.
            For more help on thresholding, see the <b>Identify</b> extensions."""))
