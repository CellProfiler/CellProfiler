...
metadata extraction. You can extract metadata from all images from <b>Images</b> extensions or a subset
...
<li>You can also use metadata to reference their values in later extensions. Since the metadata is stored as an image
...
<li>Several extensions are also capable of using metadata for more specific purposes. Refer to the module setting
