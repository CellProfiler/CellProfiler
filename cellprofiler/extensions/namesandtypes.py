...
gives each image a meaningful name by which extensions in the analysis pipeline will refer to it.
...
The <b>NamesAndTypes</b> module is the last of the required input extensions. After this module, you can choose
...
extensions that require an object as input.
...
from cellprofiler.extensions.images import FilePredicate
from cellprofiler.extensions.images import ExtensionPredicate
from cellprofiler.extensions.images import ImagePredicate
...
LOAD_AS_CHOICE_HELP_TEXT = """
    ...
    represents a single intensity value. Most of the extensions in CellProfiler
    ...
    Please note that the object detection extensions such as <b>IdentifyPrimaryObjects</b>
    ...
    segmentation produced by one of the <b>Identify</b> extensions.</li>
...
class NamesAndTypes(cpm.Extension):
    ...
    def create_settings(self):
        ...
        module_explanation = [
            ...
            self.module_name,
            "by which other extensions will refer to it."]
        ...
        self.assignment_method = cps.Choice(
            ...
            of images so they can be treated separately by downstream extensions.
            ...
            a name that can be referred to in downstream extensions.</li>
            </ul></p>
            """ % globals())
    ...
    def add_objects(self, workspace, name, should_save_outlines,
        ...
        from cellprofiler.extensions.identify import add_object_location_measurements_ijv
    ...
    def get_measurement_columns(self, pipeline):
        ...
        from cellprofiler.extensions.identify import C_NUMBER, C_COUNT, \
    ...
    def get_categories(self, pipeline, object_name):
        from cellprofiler.extensions.loadimages import \
            ...
            C_HEIGHT, C_WIDTH, C_SERIES, C_FRAME, \
            C_OBJECTS_FILE_NAME, C_OBJECTS_PATH_NAME, C_OBJECTS_URL
        from cellprofiler.extensions.identify import C_LOCATION, C_NUMBER, C_COUNT
        result = []
