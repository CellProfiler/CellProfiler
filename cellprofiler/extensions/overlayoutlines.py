...
class OverlayOutlines(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.image_name = cps.ImageNameSubscriber(
            ...
            You can choose from images that were loaded or created by extensions
        ...
        self.output_image_name = cps.ImageNameProvider(
            ...
            This image can be selected in later extensions (for instance, <b>SaveImages</b>).""")
    ...
    def add_outline(self, can_remove=True):
        ...
        group.append("outline_choice", cps.Choice(
            ...
            extensions. For legacy pipelines or to continue using the outline
        ...
        group.append("outline_name", cps.OutlineNameSubscriber(
            ...
            module. Each of the <b>Identify</b> extensions has a checkbox that
