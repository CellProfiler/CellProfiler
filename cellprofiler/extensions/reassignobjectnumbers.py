...
class ReassignObjectNumbers(cpm.Extension):
    ...
    def create_settings(self):
        self.objects_name = cps.ObjectNameSubscriber(
            ...
            You can use any objects that were created in previous extensions, such as
        ...
        self.output_objects_name = cps.ObjectNameProvider(
            ...
            You can use this name in subsequent extensions that take objects as inputs.""")
