...
from cellprofiler.extensions.identify import C_PARENT, C_CHILDREN, R_PARENT, R_CHILD
from cellprofiler.extensions.identify import FF_PARENT, FF_CHILDREN_COUNT
...
class RelateObjects(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.wants_per_parent_means = cps.Binary(
            ...
            extensions that make measurements of the children objects.""" % globals())
