...
class RescaleIntensity(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.rescale_method = cps.Choice(
            ...
            CellProfiler extensions require the incoming image to be in the standard 0
            to 1 range, so this conversion may cause downstream extensions to behave
