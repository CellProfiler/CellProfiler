...
class SaveImages(cpm.Extension):
    ...
    def create_settings(self):
        self.save_image_or_figure = cps.Choice(
            ...
            Outlines created by <b>Identify</b> extensions can also be saved with this option, but you must
        ...
        self.update_file_names = cps.Binary(
            ...
            <li>Allowing downstream extensions (e.g., <b>CreateWebPage</b>) to access
