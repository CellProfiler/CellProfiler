...
class StraightenWorms(cpm.Extension):
    ...
    def create_settings(self):
        ...
        self.objects_name = cps.ObjectNameSubscriber(
            ...
            saved from a previous run and loaded via the <b>Input</b> extensions, objects
    ...
    def add_image(self, can_delete=True):
        ...
        group.append("image_name", cps.ImageNameSubscriber(
            ...
            then be used in subsequent extensions such as
