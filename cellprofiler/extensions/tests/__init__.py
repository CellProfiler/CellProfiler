...
set_headless()
from cellprofiler.extensions import builtin_modules, all_modules
...
class TestAllModules(unittest.TestCase):
    '''Test things having to do with extensions'''
    ...
    def test_01_01_import_all(self):
        ...
        for module_name in \
            ...
            self.assertTrue(
                    ...
                    "%s is missing from the list of available extensions" %
                    module_name)
...
def example_images_directory():
    ...
    d = os.path.split(fyle)[0]  # trunk.CellProfiler.cellprofiler.extensions.tests
    d = os.path.split(d)[0]  # trunk.CellProfiler.cellprofiler.extensions
