...
import cellprofiler.extensions.imagemath as I
...
"""
    ...
    def test_01_01_load_matlab(self):
        ...
        #
        # There are 3 ImageMath extensions:
        # 1)
    ...
    def test_01_02_load_wierd_matlab(self):
        '''Load some ImageMath extensions with constants typed in instead of images'''
        data = ('eJzzdQzxcXRSMNUzUPB1DNFNy8xJ1VEIyEksScsvyrVSCHAO9/TTUXAuSk0s'
...
NamesAndTypes:[module_num:3|svn_version:\'Unknown\'|variable_revision_number:5|show_window:False|notes:\x5B\'The NamesAndTypes module allows you to assign a meaningful name to each image by which other extensions will refer to it.\'\x5D|batch_state:array(\x5B\x5D, dtype=uint8)|enabled:True]
