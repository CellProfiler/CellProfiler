...
See also: Any of the <b>Measure</b> extensions, <b>IdentifyPrimaryObjects</b>, <b>Groups</b>.
""" % globals()
...
class TrackObjects(cpm.Extension):
    ...
    def create_settings(self):
        self.tracking_method = cps.Choice(
            ...
            <li>You can also use the <b>Input</b> extensions to limit yourself to a few frames under
