...
from ._mask_data import MaskData
from ._objects_data import ObjectsData
from ._outlines_mixin import OutlinesMixin
from ..constants.artist import INTERPOLATION_NEAREST
from ..constants.artist import INTERPOLATION_BICUBIC
from ..constants.artist import INTERPOLATION_BILINEAR
from ..constants.artist import MODE_HIDE
from ..constants.artist import NORMALIZE_LINEAR
from ..constants.artist import NORMALIZE_LOG
...
from ..constants.artist import NORMALIZE_RAW
...
from ..constants.artist import MODE_INVERTED
from ..constants.artist import MODE_RGB


class ImageArtist(matplotlib.artist.Artist):
    ...
    def __init__(self, images=None, objects=None, masks=None, interpolation=None):
        ...
        super(ImageArtist, self).__init__()
