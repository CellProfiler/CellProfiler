...
class ImageData(ColorMixin):
    ...
    def __init__(self, name, pixel_data, mode=None, color=(1.0, 1.0, 1.0),
                 colormap=None, alpha=None, normalization=None, vmin=0, vmax=1):
...
class CPImageArtist(matplotlib.artist.Artist):
    ...
    def __initialize_objects_sub_menu(self, event, sub_menu, data):
        ...
        self.__add_alpha_item(event, sub_menu, data,
