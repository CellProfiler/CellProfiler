...
try:
    ...
    if any([x == "--html" for x in sys.argv]) and sys.platform.startswith(
            "win"):
...
folder names containing images. This functionality is used in the 
<b>Metadata</b> module for regular expression matching of folders, via the 
...
for key, value in enumerate(EACH_PREFERENCE_HELP):
    PREFERENCES_HELP += """<li><b>""" + value[0] + """:</b>""" + value[
        1] + """</li>"""
PREFERENCES_HELP += """</ul>"""
