...
<tr>
    <td width="1">&nbsp;</td>
    <td colspan="2"><a href="loadexample:http://d1zymp9ayga15t.cloudfront.net/ExampleFlyImages/ExampleFlyURL.cppipe">Load</a> an example pipeline, then click on the "Analyze Images" button.</td>
</tr>
<tr>
