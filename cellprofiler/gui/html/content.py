...
SELECTING_IMAGES_REF = urllib.parse.quote("Selecting images")

CONFIGURE_IMAGES_REF = urllib.parse.quote("Configure images")

IDENTIFY_FEATUREES_REF = urllib.parse.quote("Identifying features")
...
MAKING_MEASUREMENTS_REF = urllib.parse.quote("Making measurements")
...
EXPORTING_RESULTS_REF = urllib.parse.quote("Exporting results")
...
TEST_MODE_REF = urllib.parse.quote("Using test mode")
RUNNING_YOUR_PIPELINE_REF = urllib.parse.quote("Analyzing your images")

IN_APP_HELP_REF = urllib.parse.quote("Using the help")
IN_APP_HELP_HELP = '''
