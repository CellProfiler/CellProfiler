...
class Workspace(workspace.Workspace):
    def create_or_find_figure(self, title=None, subplots=None, window_name=None):
        ...
        if window_name is None:
            window_name = cellprofiler.gui.widget.frame._figure_frame.window_name(
                self.__module
            )

        if self.__create_new_window:
            figure = cellprofiler.gui.widget.frame._figure_frame.Figure(
                parent=self, title=title, name=window_name, subplots=subplots
            )
        else:
            figure = cellprofiler.gui.widget.frame._figure_frame.create_or_find(
    ...
    def get_module_figure(self, module, image_set_number, parent=None):
        ...
        window_name = cellprofiler.gui.widget.frame._figure_frame.window_name(module)
