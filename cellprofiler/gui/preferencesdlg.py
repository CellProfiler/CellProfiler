...
class PreferencesDlg(wx.Dialog):
    ...
    def __init__(self, parent=None, ID=-1, title="CellProfiler preferences",
        ...
        for text, getter, setter, ui_info, help_text in p:
            ...
            isinstance(ui_info, str)):
                ...
                if getter == cellprofiler.preference.get_ij_plugin_directory:
    ...
    def get_preferences(self):
        ...
        return [["Default Input Folder",
                ...
                ["Default colormap",
                 cellprofiler.preference.get_default_colormap,
                 cellprofiler.preference.set_default_colormap,
                 cmaps, cellprofiler.gui.help.DEFAULT_COLORMAP_HELP],
                ["Window background",
                 cellprofiler.preference.get_background_color,
                 cellprofiler.preference.set_background_color,
                 COLOR, cellprofiler.gui.help.WINDOW_BACKGROUND_HELP],
                ["Error color",
                 cellprofiler.preference.get_error_color,
                 cellprofiler.preference.set_error_color,
                 COLOR, cellprofiler.gui.help.ERROR_COLOR_HELP],
                ["Primary outline color",
                 cellprofiler.preference.get_primary_outline_color,
                 cellprofiler.preference.set_primary_outline_color,
                 COLOR, cellprofiler.gui.help.PRIMARY_OUTLINE_COLOR_HELP],
                ["Secondary outline color",
                 cellprofiler.preference.get_secondary_outline_color,
                 cellprofiler.preference.set_secondary_outline_color,
                 COLOR, cellprofiler.gui.help.SECONDARY_OUTLINE_COLOR_HELP],
                ["Tertiary outline color",
                 cellprofiler.preference.get_tertiary_outline_color,
                 cellprofiler.preference.set_tertiary_outline_color,
                 COLOR, cellprofiler.gui.help.TERTIARY_OUTLINE_COLOR_HELP],
                ["Interpolation mode",
                 cellprofiler.preference.get_interpolation_mode,
                 cellprofiler.preference.set_interpolation_mode,
                 [cellprofiler.preference.IM_NEAREST, cellprofiler.preference.IM_BILINEAR, cellprofiler.preference.IM_BICUBIC],
                 cellprofiler.gui.help.INTERPOLATION_MODE_HELP],
                ["Intensity normalization",
                 cellprofiler.preference.get_intensity_mode,
                 cellprofiler.preference.set_intensity_mode,
                 [cellprofiler.preference.INTENSITY_MODE_RAW, cellprofiler.preference.INTENSITY_MODE_NORMAL,
                  cellprofiler.preference.INTENSITY_MODE_LOG],
                 cellprofiler.gui.help.INTENSITY_MODE_HELP],
                ["CellProfiler plugins directory",
                 cellprofiler.preference.get_plugin_directory,
                 cellprofiler.preference.set_plugin_directory,
                ...
                ["Display welcome text on startup",
                 cellprofiler.preference.get_startup_blurb,
                 cellprofiler.preference.set_startup_blurb,
                 CHOICE, cellprofiler.gui.help.SHOW_STARTUP_BLURB_HELP],
                ["Warn if Java runtime environment not present",
                 cellprofiler.preference.get_report_jvm_error,
                 cellprofiler.preference.set_report_jvm_error,
                 CHOICE, cellprofiler.gui.help.REPORT_JVM_ERROR_HELP],
                ['Show the "Analysis complete" message at the end of a run',
                 cellprofiler.preference.get_show_analysis_complete_dlg,
                 cellprofiler.preference.set_show_analysis_complete_dlg,
                 CHOICE, cellprofiler.gui.help.SHOW_ANALYSIS_COMPLETE_HELP],
                ['Show the "Exiting test mode" message',
                 cellprofiler.preference.get_show_exiting_test_mode_dlg,
                 cellprofiler.preference.set_show_exiting_test_mode_dlg,
                 CHOICE, cellprofiler.gui.help.SHOW_EXITING_TEST_MODE_HELP],
                ['Warn if images are different sizes',
                 cellprofiler.preference.get_show_report_bad_sizes_dlg,
                 cellprofiler.preference.set_show_report_bad_sizes_dlg,
                 CHOICE, cellprofiler.gui.help.SHOW_REPORT_BAD_SIZES_DLG_HELP],
                ['Show the sampling menu',
                 cellprofiler.preference.get_show_sampling,
                 cellprofiler.preference.set_show_sampling,
                ...
                ['Use more figure space',
                 cellprofiler.preference.get_use_more_figure_space,
                 cellprofiler.preference.set_use_more_figure_space,
                 CHOICE,
                 cellprofiler.gui.help.USE_MORE_FIGURE_SPACE_HELP
                 ],
                ['Maximum number of workers',
                 cellprofiler.preference.get_max_workers,
                 cellprofiler.preference.set_max_workers,
                 IntegerPreference(1, cellprofiler.preference.default_max_workers() * 4),
                 cellprofiler.gui.help.MAX_WORKERS_HELP],
                ['Temporary folder',
                 cellprofiler.preference.get_temporary_directory,
                 (lambda x: cellprofiler.preference.set_temporary_directory(x, globally=True)),
                 DIRBROWSE,
                 cellprofiler.gui.help.TEMP_DIR_HELP],
                ['Maximum memory for Java (MB)',
                 cellprofiler.preference.get_jvm_heap_mb,
                 cellprofiler.preference.set_jvm_heap_mb,
                 IntegerPreference(128, 64000),
                 cellprofiler.gui.help.JVM_HEAP_HELP],
                ['Save pipeline and/or file list in addition to project',
                 cellprofiler.preference.get_save_pipeline_with_project,
                 cellprofiler.preference.set_save_pipeline_with_project,
                 cellprofiler.preference.SPP_ALL,
                 cellprofiler.gui.help.SAVE_PIPELINE_WITH_PROJECT_HELP],
                ['Folder name regular expression guesses',
                 cellprofiler.preference.get_pathname_re_guess_file,
                 cellprofiler.preference.set_pathname_re_guess_file,
                 FILEBROWSE,
                 cellprofiler.gui.help.FOLDER_RE_GUESS_HELP],
                ['File name regular expression guesses',
                 cellprofiler.preference.get_filename_re_guess_file,
                 cellprofiler.preference.set_filename_re_guess_file,
                 FILEBROWSE,
                 cellprofiler.gui.help.FILE_RE_GUESS_HELP],
                ['Batch Profiler URL',
                 cellprofiler.preference.get_batchprofiler_url,
                 cellprofiler.preference.set_batchprofiler_url,
                 None,
    ...
    @staticmethod
    def get_title_font():
        return "%s,%f" % (cellprofiler.preference.get_title_font_name(),
                          cellprofiler.preference.get_title_font_size())

    @staticmethod
    def set_title_font(font):
        name, size = font.split(",")
        cellprofiler.preference.set_title_font_name(name)
        cellprofiler.preference.set_title_font_size(float(size))

    @staticmethod
    def get_table_font():
        return "%s,%f" % (cellprofiler.preference.get_table_font_name(),
                          cellprofiler.preference.get_table_font_size())

    @staticmethod
    def set_table_font(font):
        name, size = font.split(",")
        cellprofiler.preference.set_table_font_name(name)
        cellprofiler.preference.set_table_font_size(float(size))
