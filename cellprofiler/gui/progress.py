...
class ProgressFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.image_set_control = wx.StaticText(self.panel, -1,
                                               label=image_set_label(None,
                                                                     None))
        sizer.Add(self.image_set_control, 0, wx.LEFT | wx.RIGHT, 5)
        self.current_module_control = wx.StaticText(self.panel, -1,
        ...
        self.stop_button = wx.BitmapButton(self.panel, -1,
                                           bitmap=wx.BitmapFromImage(
    ...
    def on_timer(self, event):
        ...
        if remaining:
            self.gauge.SetValue(
                100 * self.elapsed_time() / (self.elapsed_time() + remaining))
    ...
    def start_module(self, module, num_modules, image_set_index,
        ...
        self.image_set_control.SetLabel(
            image_set_label(image_set_index + 1, num_image_sets))
    ...
    def remaining_time(self):
        ...
        if self.end_times is None:
            ...
            current_module_so_far = self.adjusted_time() - self.end_times[
                1 + index - 1]
