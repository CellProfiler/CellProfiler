...
class TreeCheckboxDialog(wx.Dialog):
    ...
    def __init__(self, parent, d, *args, **kwargs):
        ...
        table_sizer.Add(wx.StaticText(self, label='Key:'), pos=wx.GBPosition(0, 0), flag=wx.LEFT | wx.RIGHT, border=3)
        for i, (bitmap, description) in enumerate((
            ...
            table_sizer.Add(bitmap_ctrl, pos=wx.GBPosition(i, 1), flag=wx.RIGHT, border=5)
