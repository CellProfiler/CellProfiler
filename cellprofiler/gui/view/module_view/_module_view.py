...
from ...components.dialog import _tree_checkbox_dialog
from cellprofiler.gui import cornerbuttonmixin
from ...components.control import _metadata_control
from cellprofiler.gui import namesubscriber
from cellprofiler.gui.constants.module_view import ABSOLUTE
from cellprofiler.gui.constants.module_view import CHECK_TIMEOUT_SEC
from cellprofiler.gui.constants.module_view import EDIT_TIMEOUT_SEC
...
from cellprofiler.gui.utilities.module_view import category_text_control_name
from cellprofiler.gui.utilities.module_view import colorbar_ctrl_name
from cellprofiler.gui.utilities.module_view import combobox_ctrl_name
from cellprofiler.gui.utilities.module_view import custom_label_name
from cellprofiler.gui.utilities.module_view import edit_control_name
from cellprofiler.gui.utilities.module_view import encode_label
from cellprofiler.gui.utilities.module_view import feature_control_name
from cellprofiler.gui.utilities.module_view import feature_text_control_name
from cellprofiler.gui.utilities.module_view import folder_label_name
from cellprofiler.gui.utilities.module_view import grid_control_name
from cellprofiler.gui.utilities.module_view import help_ctrl_name
from cellprofiler.gui.utilities.module_view import max_control_name
from cellprofiler.gui.utilities.module_view import min_control_name
from cellprofiler.gui.utilities.module_view import object_control_name
from cellprofiler.gui.utilities.module_view import object_text_control_name
from cellprofiler.gui.utilities.module_view import request_module_validation
from cellprofiler.gui.utilities.module_view import scale_control_name
from cellprofiler.gui.utilities.module_view import scale_text_ctrl_name
from cellprofiler.gui.utilities.module_view import subedit_control_name
from cellprofiler.gui.utilities.module_view import text_control_name
from cellprofiler.gui.utilities.module_view import x_control_name
from cellprofiler.gui.utilities.module_view import y_control_name
...
class ModuleView:
    ...
    def make_filename_text_control(self, v, control):
        ...
        if control is None:
            ...
            if v.metadata_display:
                edit_control = _metadata_control.MetadataControl(
                    self.__pipeline,
                    self.__module,
                    control,
                    value=v.value,
    ...
    def make_directory_path_control(self, v, control_name, control):
        ...
        if control is None:
            ...
            if v.allow_metadata:
                custom_ctrl = _metadata_control.MetadataControl(
                    self.__pipeline,
                    self.__module,
                    control,
                    value=v.custom_path,
    ...
    def make_text_control(self, v, control_name, control):
        ...
        if not control:
            if v.metadata_display:
                control = _metadata_control.MetadataControl(
                    self.__pipeline,
                    self.__module,
                    self.__module_panel,
                    value=v.value,
    ...
    def __on_workspace_event(self, event):
        import cellprofiler.gui.model._workspace_model as cpw
