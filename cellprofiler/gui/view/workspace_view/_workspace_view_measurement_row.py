...
import cellprofiler.gui.view.workspace_view._workspace_view
...
class WorkspaceViewMeasurementRow:
    ...
    def __init__(self, panel, grid_sizer, row_idx, on_change):
        ...
        grid_sizer.Add(
            ...
            (
                row_idx,
                cellprofiler.gui.view.workspace_view._workspace_view.WorkspaceView.C_CHOOSER,
            ),
            flag=wx.EXPAND,
        )
        ...
        grid_sizer.Add(
            ...
            (
                row_idx,
                cellprofiler.gui.view.workspace_view._workspace_view.WorkspaceView.C_COLOR,
            ),
        ...
        grid_sizer.Add(
            ...
            (
                row_idx,
                cellprofiler.gui.view.workspace_view._workspace_view.WorkspaceView.C_SHOW,
            ),
            flag=wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_TOP,
        )
        #
