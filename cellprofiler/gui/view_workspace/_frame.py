...
from .control import ObjectList
from .control import Mask
...
class Frame:
    ...
    def add_image_row(self, can_delete=True):
        self.add_row(Image, self.image_rows, self.image_grid, can_delete)

    def add_objects_row(self, can_delete=True):
        self.add_row(ObjectList, self.object_rows, self.object_grid, can_delete)

    def add_mask_row(self, can_delete=True):
        self.add_row(Mask, self.mask_rows, self.mask_grid, can_delete)
    ...
    def on_measurement_changed(self, measurement_row):
        assert isinstance(measurement_row, Measurement)
