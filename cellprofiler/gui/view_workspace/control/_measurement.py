...
from cellprofiler.gui.view_workspace._frame import Frame
...
class Measurement:
    ...
    def __init__(self, panel, grid_sizer, row_idx, on_change):
        ...
        row_idx - the control # in the grid sizer
        ...
        grid_sizer.Add(self.choice_panel, (row_idx, Frame.C_CHOOSER), flag=wx.EXPAND)
