...
import cellprofiler.gui.model._workspace_model
...
class ParameterSampleFrame(wx.Frame):
    ...
    def prepare_for_run(self):
        ...
        workspace = cellprofiler.gui.model._workspace_model.Workspace(
            self.__pipeline,
            None,
            None,
            None,
    ...
    def run_module(self, module):
        ...
        try:
            ...
            self.__workspace = cellprofiler.gui.model._workspace_model.Workspace(
                self.__pipeline,
                module,
                self.__measurements,
                self.__object_set,
