...
from cellprofiler.modules.correctilluminationcalculate import IC_BACKGROUND, \
    IC_REGULAR
...
class CorrectIlluminationApply(cpm.CPModule):
    ...
    def display(self, workspace, figure):
        ...
        for j, image in enumerate(self.images):
            ...
            illum_image = workspace.display_data.images[
                illum_correct_function_image_name]
            corrected_image = workspace.display_data.images[
    ...
    def upgrade_settings(self, setting_values, variable_revision_number,
        ...
        if not from_matlab and variable_revision_number == 2:
            ...
            rescale_option = setting_values[
                             SLOT_RESCALE_OPTION::SETTINGS_PER_IMAGE_V2]
