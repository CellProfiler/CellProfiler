...
class DisplayDataOnImage(cpm.CPModule):
    ...
    def create_settings(self):
        ...
        self.image_name = cps.ImageNameSubscriber(
            "Select the image on which to display the measurements", cps.NONE,
            doc="""
    ...
    def display(self, workspace, figure):
        ...
        title = "%s_%s" % (
        self.objects_name.value if self.objects_or_image == OI_OBJECTS else cpmeas.IMAGE,
        self.measurement.value)
    ...
    def upgrade_settings(self, setting_values, variable_revision_number,
        ...
        if from_matlab and (variable_revision_number == 2):
            ...
            measurement = '_'.join(
                (category, feature_nbr, image_name, size_scale))
            setting_values = [
...
if __name__ == "__main__":
    ...
    if dlg.ShowModal() == wx.ID_OK:
        data_tool_frame = DataToolFrame(None, module_name=tool_name,
