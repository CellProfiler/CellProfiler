    ...
    def create_settings(self):
        ...
        self.mode = cellprofiler.setting.Choice(
            ...
            <ul>
                ...
                modules in the pipeline. This setting is not compatible with data processed as 3D.</li>
                ...
                upstream modules in the pipeline. This setting is not compatible with data processed as 3D.</li>
            </ul>
            """.format(**{
