...
filter based on measurements made on the object you select. If you
...
-  *{MODE_CLASSIFIERS}*: Use a file containing trained classifier from
   CellProfiler Analyst. You will need to ensure that the measurements
...
choices.""".format(**{
        ...
        self.rules_directory = cellprofiler.setting.DirectoryPath(
            "Rules file location",
            doc="""\
*(Used only when filtering using {MODE_RULES})*
