...
class IdentifyObjectsInGrid(cellprofiler.module.Module):
    ...
    def create_settings(self):
        ...
        """
        self.grid_name = cellprofiler.setting.GridNameSubscriber(
                "Select the defined grid", cellprofiler.setting.NONE, doc="""
        ...
        self.shape_choice = cellprofiler.setting.Choice(
        ...
        self.diameter_choice = cellprofiler.setting.Choice(
    ...
    def fill_grid(self, workspace, gridding):
        ...
        i, j = numpy.mgrid[0:gridding.image_height,
        ...
        labels = numpy.zeros((gridding.image_height,
    ...
    def run_natural_circle(self, workspace, gridding):
        ...
        centers_i, centers_j = centrosome.cpmorphology.centers_of_labels(labels)
    ...
    def fit_labels_to_guiding_objects(self, workspace, labels):
        ...
        if any(guide_label.shape[i] > labels.shape[i] for i in range(2)):
            result = numpy.zeros([max(guide_label.shape[i], labels.shape[i])
    ...
    def filtered_labels(self, workspace, gridding):
        ...
        centers[:, 1:] = centrosome.cpmorphology.centers_of_labels(guide_labels)
        bad_centers = ((~ numpy.isfinite(centers[0, :])) |
    ...
    def upgrade_settings(self, setting_values, variable_revision_number,
        ...
        if from_matlab and variable_revision_number == 2:
            ...
            wants_outlines = (cellprofiler.setting.NO if save_outlines == cellprofiler.setting.DO_NOT_USE
