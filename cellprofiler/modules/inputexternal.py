...
class InputExternal(cpm.CPModule):
    ...
    def create_settings(self):
        ...
        self.add_button = cps.DoSomething('', 'Add another image name',
                                          self.add_image)
    ...
    def add_image(self, can_remove=True):
        ...
        group.append('image_name',
                     cps.ExternalImageNameProvider('Give this image a name'))
        if can_remove:
            group.append('remover',
                         cps.RemoveSettingButton('', 'Remove this image name',
