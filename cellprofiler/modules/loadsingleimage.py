...
class LoadSingleImage(cpm.CPModule):
    ...
    def visible_settings(self):
        ...
        for file_setting in self.file_settings:
            ...
            if file_setting.image_objects_choice == IO_IMAGES:
                ...
                result += [file_setting.objects_name,
        ...
        for file_setting in self.file_settings:
            if file_setting.image_objects_choice == IO_IMAGES:
                ...
                columns += [
                    ...
                    (cpmeas.IMAGE, "_".join((C_SCALING, image_name)),
                     cpmeas.COLTYPE_FLOAT),
                    (cpmeas.IMAGE, "_".join((C_HEIGHT, image_name)),
                     cpmeas.COLTYPE_INTEGER),
                    (cpmeas.IMAGE, "_".join((C_WIDTH, image_name)),
                     cpmeas.COLTYPE_INTEGER)]
            else:
                image_name = file_setting.objects_name.value
                path_name_category = C_OBJECTS_PATH_NAME
    ...
    def get_measurements(self, pipeline, object_name, category):
        ...
        if object_name == cpmeas.IMAGE:
            if category in (
            C_FILE_NAME, C_MD5_DIGEST, C_PATH_NAME, C_SCALING, C_HEIGHT,
            C_WIDTH):
    ...
    def upgrade_settings(self, setting_values, variable_revision_number,
        ...
        if variable_revision_number == 1 and not from_matlab:
            ...
            elif setting_values[0] in (
            DIR_CUSTOM_FOLDER, DIR_CUSTOM_WITH_METADATA):
                custom_directory = setting_values[1]
