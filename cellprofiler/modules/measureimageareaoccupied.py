...
if you precede it with thresholding performed by <b>IdentifyPrimaryObjects</b>.</p>
...
class MeasureImageAreaOccupied(cpm.CPModule):
    ...
    def visible_settings(self):
        ...
        for index, object in enumerate(self.objects):
            temp = object.visible_settings()
            if not object.should_save_image:
                temp.remove(object.image_name)
            result += temp
