...
class MeasureObjectIntensity(cpm.CPModule):
    ...
    def upgrade_settings(self, setting_values, variable_revision_number,
        ...
        if variable_revision_number == 2:
            ...
            setting_values = [str(num_imgs)] + setting_values[
                                               :num_imgs] + setting_values[
                                                            num_imgs + 1:]
            variable_revision_number = 3
        ...
        for image_name in [img.name for img in self.images]:
            ...
            for object_name in [obj.name for obj in self.objects]:
                ...
                for labels, lindexes in objects.get_labels():
                    ...
                    _, masked_image = cpo.crop_labels_and_image(labels,
                                                                masked_image)
                    ...
                    if has_objects:
                        ...
                        max_position = np.array(
                            fix(nd.maximum_position(limg, llabels, lindexes)),
                            dtype=int)
