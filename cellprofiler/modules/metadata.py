...
class Metadata(cpm.CPModule):
    ...
    def add_extraction_method(self, can_remove = True):
        ...
        group.append("extraction_method", cps.Choice(
            "Extraction method", X_ALL_EXTRACTION_METHODS, doc="""
            ...
            the <b>NamesAndTypes</b> or <b>Groups</b> module, or <i>%(METADATA_HELP_REF)s</i>"""%globals()))
        
        group.append("source", cps.Choice(
            "Source", [XM_FILE_NAME, XM_FOLDER_NAME],doc = """
