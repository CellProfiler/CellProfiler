...
F_ALL = [F_BOTHAT, F_BRANCHPOINTS, F_BRIDGE, F_CLEAN, F_CLOSE, F_CONVEX_HULL,
         ...
         F_FILL_SMALL, F_HBREAK, F_INVERT, F_LIFE, F_MAJORITY, F_OPEN,
         F_OPENLINES, F_REMOVE,
         F_SHRINK, F_SKEL, F_SKELPE, F_SPUR, F_THICKEN, F_THIN, F_TOPHAT,
         F_VBREAK]
...
class Morph(cpm.CPModule):
    ...
    def add_function(self, can_remove=True):
        ...
        group.append("custom_repeats",
                     cps.Integer(self.CUSTOM_REPEATS_TEXT, 2, 1,
    ...
    def run_function(self, function, pixel_data, mask):
        ...
        if (function_name in (F_BRANCHPOINTS, F_BRIDGE, F_CLEAN, F_DIAG,
                ...
                (is_binary and
                         function_name in (
                     F_CLOSE, F_DILATE, F_ERODE, F_OPEN))):
            ...
            if function_name == F_BRANCHPOINTS:
                ...
                return morph.openlines(pixel_data, linelength=custom_repeats,
                                       mask=mask)
            ...
            for i in range(6):
                if setting_values[i * 2 + 2] != cps.DO_NOT_USE:
                    ...
                    if (setting_values[i * 2 + 3].isdigit() and
                        ...
                        new_setting_values += [R_CUSTOM,
                                               setting_values[i * 2 + 3]]
