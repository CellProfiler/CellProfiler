...
*(Used only if “%(GAUSSIAN_FILTER)s”, “%(MEDIAN_FILTER)s”,
  “%(SMOOTH_KEEPING_EDGES)s” or “%(CIRCULAR_AVERAGE_FILTER)s” is
  selected)*
...
Select *%(YES)s* to manually enter an artifact diameter.
""" % globals())
