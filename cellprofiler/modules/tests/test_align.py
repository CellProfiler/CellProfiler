...
class TestAlign(unittest.TestCase):
    ...
    def test_01_01_load_matlab(self):
        ...
        self.assertEqual(module.alignment_method.value, cellprofiler.modules.align.M_CROSS_CORRELATION)
    ...
    def test_01_02_load_v1(self):
        ...
        self.assertEqual(module.additional_images[0].align_choice.value, cellprofiler.modules.align.A_SIMILARLY)
        self.assertEqual(module.additional_images[1].align_choice.value, cellprofiler.modules.align.A_SEPARATELY)
        self.assertEqual(module.alignment_method.value, cellprofiler.modules.align.M_MUTUAL_INFORMATION)
        self.assertEqual(module.crop_mode, cellprofiler.modules.align.C_SAME_SIZE)
