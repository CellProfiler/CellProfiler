...
class TestCorrectImage_Calculate(unittest.TestCase):
    ...
    def test_06_01_load_matlab(self):
        ...
        self.assertEqual(module.intensity_choice, cellprofiler.modules.correctilluminationcalculate.IC_REGULAR)
        self.assertFalse(module.dilate_objects)
        self.assertEqual(module.rescale_option, cellprofiler.setting.YES)
        self.assertEqual(module.each_or_all, cellprofiler.modules.correctilluminationcalculate.EA_EACH)
        self.assertEqual(module.smoothing_method, cellprofiler.modules.correctilluminationcalculate.SM_NONE)
