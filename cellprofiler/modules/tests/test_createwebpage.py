...
"""
        ...
        self.assertEqual(module.web_page_file_name,
                         "sbsimages\\g<Controls>.html")
        self.assertEqual(module.directory_choice.dir_choice, C.DIR_SAME)
...
"""
        ...
        for i in range(len(image_paths)):
            ...
            if metadata is not None:
                for key in metadata.keys():
                    ...
                    measurements[cpmeas.IMAGE, feature, image_number] = values[
                        i]
    ...
    def test_04_03_metadata_filename(self):
        ...
        for file_name, image_name in (('foo.html', 'A01.png'),
                                      ('bar.html', 'A02.png')):
            path = os.path.join(cpprefs.get_default_image_directory(),
                                file_name)
    ...
    def test_04_04_abspath(self):
        ...
        dom = self.read_html(
            os.path.join(self.alt_directory, DEFAULT_HTML_FILE))
        imgs = dom.getElementsByTagName("img")
