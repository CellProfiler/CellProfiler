...
"""
    ...
    def test_02_02_measurements(self):
        ...
        expected_columns = [
            (cpmeas.IMAGE, E.I.FF_COUNT % OUTPUT_OBJECTS_NAME,
             cpmeas.COLTYPE_INTEGER),
            (OUTPUT_OBJECTS_NAME, E.I.M_NUMBER_OBJECT_NUMBER,
             cpmeas.COLTYPE_INTEGER),
            (
            ...
            (OUTPUT_OBJECTS_NAME, E.I.FF_PARENT % INPUT_OBJECTS_NAME,
             cpmeas.COLTYPE_INTEGER),
            (INPUT_OBJECTS_NAME, E.I.FF_CHILDREN_COUNT % OUTPUT_OBJECTS_NAME,
             cpmeas.COLTYPE_INTEGER)]

        for column in columns:
            self.assertTrue(
                any([all([column[i] == expected[i] for i in range(3)])
        ...
        d = {cpmeas.IMAGE: {E.I.C_COUNT: [OUTPUT_OBJECTS_NAME],
                            "Foo": []},
             INPUT_OBJECTS_NAME: {
                 E.I.C_CHILDREN: ["%s_Count" % OUTPUT_OBJECTS_NAME],
                 "Foo": []},
             OUTPUT_OBJECTS_NAME: {
