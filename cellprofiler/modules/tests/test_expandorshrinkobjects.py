...
class TestExpandOrShrinkObjects(unittest.TestCase):
    def test_01_01_load_matlab(self):
        ...
        for module, output_object_name, operation, has_outline in \
                ((modules[2], "ShrunkenNuclei", cellprofiler.modules.expandorshrinkobjects.O_SHRINK_INF, False),
                 (modules[3], "ExpandedOnceNuclei", cellprofiler.modules.expandorshrinkobjects.O_EXPAND, True),
                 (modules[4], "ShrunkenOnceNuclei", cellprofiler.modules.expandorshrinkobjects.O_SHRINK, False),
                 (modules[5], "ExpandedNuclei", cellprofiler.modules.expandorshrinkobjects.O_EXPAND_INF, False),
                 (modules[6], "DividedNuclei", cellprofiler.modules.expandorshrinkobjects.O_DIVIDE, False)):
    ...
    def test_01_02_load_v1(self):
        ...
        self.assertTrue(isinstance(module, cellprofiler.modules.expandorshrinkobjects.ExpandOrShrink))
        self.assertEqual(module.object_name, "Nuclei")
        self.assertEqual(module.output_object_name, "ShrunkenNuclei")
        self.assertEqual(module.operation, cellprofiler.modules.expandorshrinkobjects.O_EXPAND)
