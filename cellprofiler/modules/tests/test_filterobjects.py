...
Module #3: FilterByObjectMeasurement revision - 6
     ...
     What do you want to call the outlines of the identified objects? Type "Do not use" to ignore.    OutlineObjects
        ...
        self.assertEqual(klo.filter_choice.value, cellprofiler.modules.filterobjects.FI_MAXIMAL_PER_OBJECT)
        ...
        self.assertEqual(fbom1.filter_choice.value, cellprofiler.modules.filterobjects.FI_LIMITS)
        ...
        self.assertEqual(fbom2.filter_choice.value, cellprofiler.modules.filterobjects.FI_LIMITS)
    ...
    def test_05_02_load(self):
        ...
        self.assertEqual(module.filter_choice.value, cellprofiler.modules.filterobjects.FI_LIMITS)
    ...
    def test_05_03_test_load_v2(self):
        ...
        self.assertEqual(module.object_name.value, 'Nuclei')
        self.assertEqual(module.mode, cellprofiler.modules.filterobjects.MODE_RULES)
...
"""
    ...
    def test_09_02_discard_mask_objects(self):
        ...
        input_objects = cellprofiler.region.Region()
