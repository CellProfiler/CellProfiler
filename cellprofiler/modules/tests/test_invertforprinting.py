...
class TestInvertForPrinting(unittest.TestCase):
    def test_01_01_load_matlab(self):
        ...
        self.assertEqual(module.green_output_image.value,
                         "InvertedDisplayGreen")
    ...
    def run_module(self, color_image=None,
        ...
        for image, name, setting, check in \
                ((color_image, I_COLOR_IN, module.color_input_image, None),
                 (red_image, I_RED_IN, module.red_input_image,
                  module.wants_red_input),
                 (green_image, I_GREEN_IN, module.green_input_image,
                  module.wants_green_input),
                 (blue_image, I_BLUE_IN, module.blue_input_image,
                  module.wants_blue_input)):
        ...
        for provider in image_set.providers:
            result[provider.get_name()] = provider.provide_image(
                image_set).pixel_data
        return result
    ...
    def test_02_02_color_to_bw(self):
        ...
        self.assertTrue(all([color in d.keys()
                             for color in
                             (I_RED_OUT, I_GREEN_OUT, I_BLUE_OUT)]))
