...
class TestMaskObjects(unittest.TestCase):
    def test_01_01_load_matlab_exclude(self):
        ...
        self.assertTrue(isinstance(module, cellprofiler.modules.maskobjects.MaskObjects))
        self.assertEqual(module.object_name.value, "Nuclei")
        self.assertEqual(module.mask_choice.value, cellprofiler.modules.maskobjects.MC_OBJECTS)
        self.assertEqual(module.masking_objects.value, "Cells")
        self.assertEqual(module.remaining_objects.value, "FilteredNuclei")
        self.assertEqual(module.retain_or_renumber.value, cellprofiler.modules.maskobjects.R_RENUMBER)
        self.assertEqual(module.overlap_choice.value, cellprofiler.modules.maskobjects.P_MASK)
        ...
        self.assertEqual(module.retain_or_renumber.value, cellprofiler.modules.maskobjects.R_RETAIN)
        self.assertEqual(module.overlap_choice.value, cellprofiler.modules.maskobjects.P_REMOVE)
...
"""
        ...
        self.assertEqual(module.mask_choice.value, cellprofiler.modules.maskobjects.MC_IMAGE)
        self.assertEqual(module.masking_image.value, "WellBoundary")
        self.assertEqual(module.remaining_objects.value, "MaskedCells")
        self.assertEqual(module.retain_or_renumber.value, cellprofiler.modules.maskobjects.R_RETAIN)
        self.assertEqual(module.overlap_choice.value, cellprofiler.modules.maskobjects.P_KEEP)
        self.assertTrue(module.wants_outlines)
        ...
        self.assertEqual(module.retain_or_renumber.value, cellprofiler.modules.maskobjects.R_RENUMBER)
        self.assertEqual(module.overlap_choice.value, cellprofiler.modules.maskobjects.P_REMOVE_PERCENTAGE)
...
MaskObjects:[module_num:1|svn_version:\'Unknown\'|variable_revision_number:1|show_window:True|notes:\x5B\x5D]
    ...
    def make_workspace(self, labels, overlap_choice, masking_objects=None,
        ...
        module.mask_choice.value = (cellprofiler.modules.maskobjects.MC_OBJECTS if masking_objects is not None
        ...
        module.retain_or_renumber.value = (cellprofiler.modules.maskobjects.R_RENUMBER if renumber
    ...
    def test_02_01_measurement_columns(self):
        ...
        for expected in (
                (cellprofiler.measurement.IMAGE, cellprofiler.modules.maskobjects.I.FF_COUNT % OUTPUT_OBJECTS, cellprofiler.measurement.COLTYPE_INTEGER),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_LOCATION_CENTER_X, cellprofiler.measurement.COLTYPE_FLOAT),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_LOCATION_CENTER_Y, cellprofiler.measurement.COLTYPE_FLOAT),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.FF_PARENT % INPUT_OBJECTS, cellprofiler.measurement.COLTYPE_INTEGER),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_NUMBER_OBJECT_NUMBER, cellprofiler.measurement.COLTYPE_INTEGER),
                (INPUT_OBJECTS, cellprofiler.modules.maskobjects.I.FF_CHILDREN_COUNT % OUTPUT_OBJECTS, cellprofiler.measurement.COLTYPE_INTEGER)):
    ...
    def test_02_02_measurement_categories(self):
        ...
        self.assertEqual(categories[0], cellprofiler.modules.maskobjects.I.C_COUNT)

        categories = module.get_categories(workspace.pipeline, OUTPUT_OBJECTS)
        self.assertEqual(len(categories), 3)
        for category, expected in zip(sorted(categories),
                                      (cellprofiler.modules.maskobjects.I.C_LOCATION, cellprofiler.modules.maskobjects.I.C_NUMBER,
                                       cellprofiler.modules.maskobjects.I.C_PARENT)):
            self.assertEqual(category, expected)

        categories = module.get_categories(workspace.pipeline, INPUT_OBJECTS)
        self.assertEqual(len(categories), 1)
        self.assertEqual(categories[0], cellprofiler.modules.maskobjects.I.C_CHILDREN)

    def test_02_03_measurements(self):
        workspace, module = self.make_workspace(numpy.zeros((20, 10), int),
                                                cellprofiler.modules.maskobjects.P_MASK,
                                                numpy.zeros((20, 10), int))
        ftr_count = (cellprofiler.modules.maskobjects.I.FF_CHILDREN_COUNT % OUTPUT_OBJECTS).split('_', 1)[1]
        d = {"Foo": {},
             cellprofiler.measurement.IMAGE: {"Foo": [], cellprofiler.modules.maskobjects.I.C_COUNT: [OUTPUT_OBJECTS]},
             OUTPUT_OBJECTS: {"Foo": [],
                              cellprofiler.modules.maskobjects.I.C_LOCATION: [cellprofiler.modules.maskobjects.I.FTR_CENTER_X,
                                                                              cellprofiler.modules.maskobjects.I.FTR_CENTER_Y],
                              cellprofiler.modules.maskobjects.I.C_PARENT: [INPUT_OBJECTS],
                              cellprofiler.modules.maskobjects.I.C_NUMBER: [cellprofiler.modules.maskobjects.I.FTR_OBJECT_NUMBER]},
             INPUT_OBJECTS: {"Foo": [],
                             cellprofiler.modules.maskobjects.I.C_CHILDREN: [ftr_count]}
             }
    ...
    def test_03_01_mask_nothing(self):
        ...
        value = m.get_current_image_measurement(cellprofiler.modules.maskobjects.I.FF_COUNT % OUTPUT_OBJECTS)
        self.assertEqual(value, 0)
        for object_name, feature in (
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_LOCATION_CENTER_X),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_LOCATION_CENTER_Y),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_NUMBER_OBJECT_NUMBER),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.FF_PARENT % INPUT_OBJECTS),
                (INPUT_OBJECTS, cellprofiler.modules.maskobjects.I.FF_CHILDREN_COUNT % OUTPUT_OBJECTS)):
            data = m.get_current_measurement(object_name, feature)
            self.assertEqual(len(data), 0)
        objects = workspace.object_set.get_objects(OUTPUT_OBJECTS)
        self.assertTrue(numpy.all(objects.segmented == 0))
    ...
    def test_03_02_mask_with_objects(self):
        ...
        expected[mask == 0] = 0
        workspace, module = self.make_workspace(labels, cellprofiler.modules.maskobjects.P_MASK, mask)
        module.run(workspace)
        objects = workspace.object_set.get_objects(OUTPUT_OBJECTS)
        ...
        for object_name, feature, expected in (
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_LOCATION_CENTER_X, expected_x),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_LOCATION_CENTER_Y, expected_y),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_NUMBER_OBJECT_NUMBER, numpy.array([1, 2])),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.FF_PARENT % INPUT_OBJECTS, numpy.array([1, 2])),
                (INPUT_OBJECTS, cellprofiler.modules.maskobjects.I.FF_CHILDREN_COUNT % OUTPUT_OBJECTS, numpy.array([1, 1]))):
            data = m.get_current_measurement(object_name, feature)
    ...
    def test_03_03_mask_with_image(self):
        ...
        expected = labels.copy()
        expected[~ mask] = 0
        workspace, module = self.make_workspace(labels, cellprofiler.modules.maskobjects.P_MASK,
                                                masking_image=mask)
        module.run(workspace)
        objects = workspace.object_set.get_objects(OUTPUT_OBJECTS)
        self.assertTrue(numpy.all(objects.segmented == expected))
    ...
    def test_03_04_mask_renumber(self):
        ...
        for object_name, feature, expected in (
                ...
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_LOCATION_CENTER_Y, expected_y),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_NUMBER_OBJECT_NUMBER, numpy.array([1, 2])),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.FF_PARENT % INPUT_OBJECTS, numpy.array([1, 3])),
                (INPUT_OBJECTS, cellprofiler.modules.maskobjects.I.FF_CHILDREN_COUNT % OUTPUT_OBJECTS, numpy.array([1, 0, 1]))):
            data = m.get_current_measurement(object_name, feature)
            self.assertEqual(len(data), len(expected))
            for value, e in zip(data, expected):
                self.assertEqual(value, e)
    ...
    def test_03_05_mask_retain(self):
        ...
        for object_name, feature, expected in (
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_LOCATION_CENTER_X, expected_x),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_LOCATION_CENTER_Y, expected_y),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.M_NUMBER_OBJECT_NUMBER, numpy.array([1, 2, 3])),
                (OUTPUT_OBJECTS, cellprofiler.modules.maskobjects.I.FF_PARENT % INPUT_OBJECTS, numpy.array([1, 2, 3])),
                (INPUT_OBJECTS, cellprofiler.modules.maskobjects.I.FF_CHILDREN_COUNT % OUTPUT_OBJECTS, numpy.array([1, 0, 1]))):
            data = m.get_current_measurement(object_name, feature)
            self.assertEqual(len(data), len(expected))
            for value, e in zip(data, expected):
    ...
    def test_03_06_mask_outlines(self):
        ...
        mask = numpy.zeros((20, 10), bool)
        mask[3:17, 2:6] = True
        expected = numpy.zeros((20, 10), bool)
        ...
        self.assertTrue(numpy.all(outlines.pixel_data == expected))
    ...
    def test_04_01_keep(self):
        ...
        expected[expected == 3] = 2
        workspace, module = self.make_workspace(labels, cellprofiler.modules.maskobjects.P_KEEP,
                                                masking_image=mask)
        module.run(workspace)
        objects = workspace.object_set.get_objects(OUTPUT_OBJECTS)
        self.assertTrue(numpy.all(objects.segmented == expected))
    ...
    def test_04_02_remove(self):
        ...
        expected = labels.copy()
        expected[labels == 2] = 0
        workspace, module = self.make_workspace(labels, cellprofiler.modules.maskobjects.P_REMOVE,
                                                masking_image=mask)
        module.run(workspace)
        objects = workspace.object_set.get_objects(OUTPUT_OBJECTS)
        self.assertTrue(numpy.all(objects.segmented == expected))
    ...
    def test_04_03_remove_percent(self):
        ...
        expected = labels.copy()
        expected[labels == 2] = 0
        workspace, module = self.make_workspace(labels, cellprofiler.modules.maskobjects.P_REMOVE_PERCENTAGE,
                                                masking_image=mask)
