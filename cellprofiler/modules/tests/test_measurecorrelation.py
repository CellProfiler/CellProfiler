...
"""
    ...
    def test_02_02_get_measurements(self):
        ...
        def meas(name):
            ...
            return module.get_measurements(None, name, "Correlation") == [
                "Correlation"]
    ...
    def test_02_03_get_measurement_images(self):
        ...
        def meas(name):
            ...
            if len(ans) == 0:
                return False
            self.assertTrue(
                ans[0] in ["%s_%s" % x for x in ((IMAGE1_NAME, IMAGE2_NAME),
    ...
    def test_03_01_correlated(self):
        ...
        mi = module.get_measurement_images(None, cpmeas.IMAGE, "Correlation",
                                           "Correlation")
        corr = m.get_current_measurement(cpmeas.IMAGE,
    ...
    def test_04_01_slope(self):
        ...
        mi = module.get_measurement_images(None, cpmeas.IMAGE, "Correlation",
                                           "Slope")
        slope = m.get_current_measurement(cpmeas.IMAGE,
                                          "Correlation_Slope_%s" % mi[0])
