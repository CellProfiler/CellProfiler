...
"""
    ...
    def test_01_02_run(self):
        ...
        a = measurements.get_current_measurement('SomeObjects',
                                                 'AreaShape_Area')
    ...
    def test_02_02_measurements_zernike(self):
        ...
        module.set_settings_from_values(settings, 1, module.module_class())
        for object_name in settings[:-1]:
            measurements = module.get_measurements(None, object_name,
                                                   'AreaShape')
    ...
    def test_03_02_zernikes_are_different(self):
        ...
        labels[21:39, 1:19] = (np.random.uniform(size=(18, 18)) > .5).astype(
            int) * 2
        objects = cpo.Objects()
        objects.segmented = labels
        object_set = cpo.ObjectSet()
