...
class TestMergeOutputFiles(unittest.TestCase):
    def execute_merge_files(self, mm):
        ...
        cellprofiler.modules.mergeoutputfiles.MergeOutputFiles.merge_files(output_file, [x[1] for x in input_files])
    ...
    def test_01_01_one(self):
        ...
        for i in range(5):
            self.assertAlmostEqual(
                    result.get_all_measurements(cellprofiler.measurement.IMAGE, "foo")[i],
