...
"""
    ...
    def test_02_01_split_zero(self):
        ...
        count = m.get_current_image_measurement(
            I.FF_COUNT % OUTPUT_OBJECTS_NAME)
        ...
        for object_name, feature_name, coltype in (
                (OUTPUT_OBJECTS_NAME, I.M_LOCATION_CENTER_X,
                 cpmeas.COLTYPE_FLOAT),
                (OUTPUT_OBJECTS_NAME, I.M_LOCATION_CENTER_Y,
                 cpmeas.COLTYPE_FLOAT),
                (OUTPUT_OBJECTS_NAME, I.M_NUMBER_OBJECT_NUMBER,
                 cpmeas.COLTYPE_INTEGER),
                (INPUT_OBJECTS_NAME, I.FF_CHILDREN_COUNT % OUTPUT_OBJECTS_NAME,
                 cpmeas.COLTYPE_INTEGER),
                (OUTPUT_OBJECTS_NAME, I.FF_PARENT % INPUT_OBJECTS_NAME,
                 cpmeas.COLTYPE_INTEGER),
                (cpmeas.IMAGE, I.FF_COUNT % OUTPUT_OBJECTS_NAME,
                 cpmeas.COLTYPE_INTEGER)):
