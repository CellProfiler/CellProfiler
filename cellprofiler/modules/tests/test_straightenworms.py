...
'''
        ...
        for alignment, module in zip((S.FLIP_TOP, S.FLIP_BOTTOM, S.FLIP_NONE),
            ...
            self.assertTrue(isinstance(module, S.StraightenWorms))
            self.assertEqual(module.objects_name, "OverlappingWorms")
            self.assertEqual(module.straightened_objects_name,
                             "StraightenedWorms")
            self.assertEqual(module.width, 20)
            self.assertEqual(module.training_set_directory.dir_choice,
            ...
            self.assertEqual(module.images[0].straightened_image_name,
                             "StraightenedImage")
    ...
    def test_03_01_get_measurement_columns(self):
        ...
        f = module.get_measurements(workspace.pipeline,
                                    STRAIGHTENED_OBJECTS_NAME, I.C_NUMBER)
        self.assertEqual(len(f), 1)
        self.assertEqual(f[0], I.FTR_OBJECT_NUMBER)

        f = module.get_measurements(workspace.pipeline,
                                    STRAIGHTENED_OBJECTS_NAME, I.C_LOCATION)
    ...
    def test_03_02_get_measurement_columns_wants_images_vertical(self):
        ...
        expected_columns = (
            [(OBJECTS_NAME,
              "_".join(
                  (S.C_WORM, ftr, image, module.get_scale_name(None, segno))),
              cpmeas.COLTYPE_FLOAT)
             for ftr, image, segno in zip(
                [S.FTR_MEAN_INTENSITY] * 10 + [S.FTR_STD_INTENSITY] * 10,
                ([STRAIGHTENED_IMAGE_NAME] * 5 + [
                    AUX_STRAIGHTENED_IMAGE_NAME] * 5) * 2,
                list(range(5)) * 4)])
        ...
        for ftr, image in zip([S.FTR_MEAN_INTENSITY, S.FTR_STD_INTENSITY] * 2,
            ...
            for expected_scale in range(5):
                self.assertTrue(
                    module.get_scale_name(None, expected_scale) in scales)
    ...
    def test_03_03_get_measurement_columns_horizontal(self):
        ...
        expected_columns = (
            [(OBJECTS_NAME,
              "_".join(
                  (S.C_WORM, ftr, image, module.get_scale_name(segno, None))),
              cpmeas.COLTYPE_FLOAT)
             for ftr, image, segno in zip(
                [S.FTR_MEAN_INTENSITY] * 10 + [S.FTR_STD_INTENSITY] * 10,
                ([STRAIGHTENED_IMAGE_NAME] * 5 + [
        ...
        for ftr, image in zip([S.FTR_MEAN_INTENSITY, S.FTR_STD_INTENSITY] * 2,
            ...
            for expected_scale in range(5):
                self.assertTrue(
                    module.get_scale_name(expected_scale, None) in scales)
                ...
                for vscale in vscales:
                    for hscale in hscales:
                        if vscale is None and hscale is None:
                            continue
                        self.assertTrue(
                            module.get_scale_name(hscale, vscale) in scales)
    ...
    def test_04_02_measure_checkerboarded_worm(self):
        ...
        image = workspace.image_set.get_image(
            STRAIGHTENED_IMAGE_NAME).pixel_data
        f1 = 1.0 / 3.0
        f2 = 2.0 / 3.0
        stripes = [
            (9, ((10, 11, 2, 1),)),
            (10, ((8, 9, 1, 1), (9, 10, 1, f2), (9, 10, 2, f1), (10, 11, 2, 1),
                  (11, 12, 2, f1), (11, 12, 3, f2), (12, 13, 3, 1))),
            (11, ((7, 9, 1, 1), (9, 10, 1, f1), (9, 10, 2, f2), (10, 11, 2, 1),
                  (11, 12, 2, f2), (11, 12, 3, f1), (12, 14, 3, 1))),
            (12, ((6, 9, 1, 1), (9, 12, 2, 1), (12, 15, 3, 1))),
            (13, ((5, 8, 1, 1), (8, 9, 1, f2), (8, 9, 2, f1), (9, 12, 2, 1),
                  (12, 13, 2, f1), (12, 13, 3, f2), (13, 16, 3, 1))),
            (14, ((4, 8, 1, 1), (8, 9, 1, f1), (8, 9, 2, f2), (9, 12, 2, 1),
                  (12, 13, 2, f2), (12, 13, 3, f1), (13, 17, 3, 1))),
            (15, ((4, 8, 1, 1), (8, 13, 2, 1), (13, 17, 3, 1))),
            (16, ((3, 8, 1, 1), (8, 13, 2, 1), (13, 18, 3, 1))),
            (17, ((4, 8, 1, 1), (8, 13, 2, 1), (13, 17, 3, 1))),
            (18, ((4, 8, 1, 1), (8, 9, 1, f1), (8, 9, 2, f2), (9, 12, 2, 1),
                  (12, 13, 2, f2), (12, 13, 3, f1), (13, 17, 3, 1))),
            (19, ((5, 8, 1, 1), (8, 9, 1, f2), (8, 9, 2, f1), (9, 12, 2, 1),
                  (12, 13, 2, f1), (12, 13, 3, f2), (13, 16, 3, 1))),
            (20, ((6, 9, 1, 1), (9, 12, 2, 1), (12, 15, 3, 1))),
            (21, ((7, 9, 1, 1), (9, 10, 1, f1), (9, 10, 2, f2), (10, 11, 2, 1),
                  (11, 12, 2, f2), (11, 12, 3, f1), (12, 14, 3, 1))),
            (22, ((8, 9, 1, 1), (9, 10, 1, f2), (9, 10, 2, f1), (10, 11, 2, 1),
                  (11, 12, 2, f1), (11, 12, 3, f2), (12, 13, 3, 1))),
            (23, ((10, 11, 2, 1),))]
        segments = [
        ...
        expected_sds = np.sqrt(
            s2(i_w * (
            image[:, :, np.newaxis] - expected_means[np.newaxis, np.newaxis,
                                      :]) ** 2) /
