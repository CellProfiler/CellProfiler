...
"""
        ...
        self.assertTrue(isinstance(module, cellprofiler.modules.unmixcolors.UnmixColors))
        ...
        for i, stain in enumerate((
                cellprofiler.modules.unmixcolors.CHOICE_HEMATOXYLIN, cellprofiler.modules.unmixcolors.CHOICE_EOSIN, cellprofiler.modules.unmixcolors.CHOICE_DAB,
                cellprofiler.modules.unmixcolors.CHOICE_FAST_RED, cellprofiler.modules.unmixcolors.CHOICE_FAST_BLUE, cellprofiler.modules.unmixcolors.CHOICE_METHYL_GREEN,
                cellprofiler.modules.unmixcolors.CHOICE_AEC, cellprofiler.modules.unmixcolors.CHOICE_ANILINE_BLUE, cellprofiler.modules.unmixcolors.CHOICE_AZOCARMINE,
                cellprofiler.modules.unmixcolors.CHOICE_ALICAN_BLUE, cellprofiler.modules.unmixcolors.CHOICE_PAS)):
    ...
    def make_image(expected, absorbances):
        ...
        log_absorbance = log_absorbance[:, :, numpy.newaxis] * absorbances[numpy.newaxis, numpy.newaxis, :]
        image = numpy.exp(log_absorbance) - eps
        return image

    def test_02_01_zeros(self):
        '''Test on an image of all zeros'''
        workspace, module = self.make_workspace(numpy.zeros((10, 20, 3)),
    ...
    def test_02_02_ones(self):
        ...
        workspace, module = self.make_workspace(numpy.ones((10, 20, 3)),
                                                [cellprofiler.modules.unmixcolors.CHOICE_HEMATOXYLIN])
        module.run(workspace)
        image = workspace.image_set.get_image(output_image_name(0))
        #
    ...
    def test_02_03_one_stain(self):
        ...
        image = self.make_image(expected, cellprofiler.modules.unmixcolors.ST_HEMATOXYLIN)
        workspace, module = self.make_workspace(image, [cellprofiler.modules.unmixcolors.CHOICE_HEMATOXYLIN])
        module.run(workspace)
        image = workspace.image_set.get_image(output_image_name(0))
    ...
    def test_02_04_two_stains(self):
        ...
        expected_1 = numpy.random.uniform(size=(10, 20)) * .5
        expected_2 = numpy.random.uniform(size=(10, 20)) * .5
        #
        # The absorbances should add in log space and multiply in
        # the image space
        #
        image = self.make_image(expected_1, cellprofiler.modules.unmixcolors.ST_HEMATOXYLIN)
        image *= self.make_image(expected_2, cellprofiler.modules.unmixcolors.ST_EOSIN)
        workspace, module = self.make_workspace(image, [
            cellprofiler.modules.unmixcolors.CHOICE_HEMATOXYLIN, cellprofiler.modules.unmixcolors.CHOICE_EOSIN])
        module.run(workspace)
    ...
    def test_02_05_custom_stain(self):
        ...
        workspace, module = self.make_workspace(image, [cellprofiler.modules.unmixcolors.CHOICE_CUSTOM])
