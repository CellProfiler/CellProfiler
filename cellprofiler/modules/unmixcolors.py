    ...
    def upgrade_settings(self, setting_values, variable_revision_number,
        ...
        if from_matlab and variable_revision_number == 0:  # If coming from DifferentiateStains, no variable revision number
            ...
            new_setting_values = ['2',  # Stain count
                                  ...
                                  CHOICE_CUSTOM,
                                  # Output stain1 choice for stain1
                                  str(float(stain1_absorbance[0])),
                                  # Red absorbance for stain1
                                  str(float(stain1_absorbance[1])),
                                  # Green absorbance for stain1
                                  str(float(stain1_absorbance[2])),
                                  # Blue absorbance for stain1
                                  setting_values[2],  # Output image name2
                                  CHOICE_CUSTOM,
                                  # Output stain1 choice for stain2
                                  str(float(stain2_absorbance[0])),
                                  # Red absorbance for stain2
                                  str(float(stain2_absorbance[1])),
                                  # Green absorbance for stain2
                                  str(float(stain2_absorbance[
                                                2]))]  # Blue absorbance for stain2
