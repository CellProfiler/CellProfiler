...
class ImageSet:
        ...
        if image.multichannel:
            ...
            if must_be_grayscale:
                ...
                if (
                    ...
                    return cellprofiler_core.image.GrayscaleImage(image)
            ...
            if must_be_rgb:
                ...
                if image.pixel_data.shape[-1] == 4:
                    ...
                    return cellprofiler_core.image.RGBImage(image)
    ...
    def add(self, name, image):
        ...
        provider = cellprofiler_core.image.abstract_image_provider._vanilla_image_provider.VanillaImageProvider(name, image)
