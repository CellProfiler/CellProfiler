...
from cellprofiler_core.module.image_segmentation import (
    ObjectProcessing,
    ImageSegmentation,
)
...
""".format(
    **{
        "ABSOLUTE_FOLDER_NAME": cellprofiler_core.preferences.ABSOLUTE_FOLDER_NAME,
        "DEFAULT_INPUT_SUBFOLDER_NAME": cellprofiler_core.preferences.DEFAULT_INPUT_SUBFOLDER_NAME,
        "DEFAULT_OUTPUT_SUBFOLDER_NAME": cellprofiler_core.preferences.DEFAULT_OUTPUT_SUBFOLDER_NAME,
