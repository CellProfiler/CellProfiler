...
class Pipeline:
    ...
    def __init__(self):
        ...
        #
        # The image file list represents individual file objects containing
        # image data. It is populated by the Images module. The Metadata
        # module then adds additional metadata to each file.
        #
        self.__image_file_list = []
        #
    ...
    def image_file_list(self):
        return self.__image_file_list

    @property
    def image_plane_list(self):
        return self.__image_plane_list

    def set_image_file_list(self, fl):
        self.__image_file_list = fl
