...
from imaging.utilities.zmqrequest import get_announcer_address
from imaging.utilities.zmqrequest import register_analysis
import collections
import cStringIO as StringIO
import imaging.eukaryote.image.image as cpimage
import imaging.eukaryote.measurements.measurements as cpmeas
import imaging.eukaryote.preferences.preferences as cpprefs
import imaging.eukaryote.workspace.workspace as cpw
...
def find_analysis_worker_source():
    return os.path.join(os.path.dirname(__file__), "analysis_worker.py")
...
def find_worker_env(idx):
    ...
    root_dir = os.path.abspath(
        os.path.join(os.path.dirname(imaging.eukaryote.__file__), '..'))
    added_paths = []
