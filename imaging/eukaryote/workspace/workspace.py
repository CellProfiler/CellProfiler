from . import DISPOSITION_CONTINUE
...
class Workspace(object):
    ...
    def set_disposition(self, disposition):
        from cellprofiler.workspace.disposition_changed_event import DispositionChangedEvent
    ...
    def load(self, filename, load_pipeline):
        ...
        '''
        import shutil
        from cellprofiler.pipeline import M_PIPELINE, M_DEFAULT_INPUT_FOLDER, M_DEFAULT_OUTPUT_FOLDER
        import cellprofiler.measurements as cpmeas
    ...
    def create(self):
        ...
        '''
        from cellprofiler.measurements import Measurements, make_temporary_file
