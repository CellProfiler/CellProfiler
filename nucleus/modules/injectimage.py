...
class InjectImage(nucleus.module.Module):
    ...
    def __init__(self, image_name, image, mask=None, release_image=False):
        ...
        self.__image = image
        self.__mask = mask
        self.image_name = nucleus.setting.NameProvider(
...
class InjectObjects(nucleus.module.Module):
    ...
    def __init__(
        ...
        self.object_name = nucleus.setting.ObjectNameProvider("text", object_name)
    ...
    def run(self, workspace):
        my_objects = nucleus.object.Objects()
