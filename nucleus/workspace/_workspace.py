...
class Workspace:
    ...
    def __init__(
        ...
        self.__grid = {}
        self.__disposition = nucleus.workspace.DISPOSITION_CONTINUE
    ...
    def interaction_request(self, module, *args, **kwargs):
        ...
        if self.interaction_handler is None:
            if nucleus.preferences.get_headless() and not headless_ok:
    ...
    def set_disposition(self, disposition):
        ...
        event = nucleus.workspace.DispositionChangedEvent(disposition)
    ...
    def load(self, filename, load_pipeline):
        ...
        try:
            ...
            #
            fd, self.__filename = nucleus.measurement.make_temporary_file()
            os.close(fd)
            ...
            if load_pipeline and self.__measurements.has_feature(
                nucleus.measurement.EXPERIMENT, M_PIPELINE
            ):
            ...
            for feature, function in (
                ...
                if self.measurements.has_feature(
                    nucleus.measurement.EXPERIMENT, feature
                ):
                    path = self.measurements[nucleus.measurement.EXPERIMENT, feature]
    ...
    def create(self):
        ...
        """
        from nucleus.measurement import make_temporary_file
