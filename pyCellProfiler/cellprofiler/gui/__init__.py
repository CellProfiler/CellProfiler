...
def get_cp_image():
    ...
    imagefile = os.path.join(cellprofiler.preferences.resources_root_directory(),'CellProfilerIcon.png')
    if os.access(imagefile, os.R_OK):
        return wx.Image(imagefile, wx.BITMAP_TYPE_PNG)
    else:
