...
Special note on saving images: See the help for the <b>SaveImages</b> module.
...
this, choose to save either the mask or cropping in <b>SaveImages</b> for the image 
...
class Crop(cpm.CPModule):
    ...
    def create_settings(self):
        ...
        self.shape=cps.Choice("Select the cropping shape",
                            ...
                            <li><i>Image:</i> A binary image. A choice box with available images will appear so
                            ...
                            the parts you want to retain. Allternately, you may have previously generated a
                            ...
                            <li><i>Cropping:</i> The cropping generated by a previous cropping module.
        ...
        self.individual_or_once = cps.Choice("Apply which cycle's cropping pattern?",
                            ...
                            should each image cycle be cropped individually (<i>Individually</i>)""")
        ...
        self.remove_rows_and_columns = cps.Choice("Remove empty rows and columns?",
                            ...
                            <ul>
                            <li><i>No:</i> Leave the image the same size</li>
