...
the user, the shape of object(s) identified by an identify module, or a shape created using a previous crop module in the pipeline.
...
class Crop(cpm.CPModule):
    ...
    def create_settings(self):
        ...
        self.shape=cps.Choice("Select the cropping shape",
                            ...
                            <li><i>Image:</i> Cropping will occur based on a binary image you specify. A choice box with available images will appear so
                            ...
                            that you have already prepared from a file. If you have created this image in an 
