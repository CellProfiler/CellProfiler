...
* To crop based on an object identified in a previous module, select "Image"
...
generated by this module.
    ...
    def create_settings(self):
        ...
        self.shape=cps.Choice("Into which shape would you like to crop?",
                              [SH_ELLIPSE, SH_RECTANGLE, SH_IMAGE,SH_CROPPING],
                              SH_ELLIPSE)
    ...
    def backwards_compatibilize(self,setting_values,variable_revision_number,
        ...
        if from_matlab and variable_revision_number==5:
            ...
            new_setting_values = list(setting_values)
            new_setting_values.extend(["None","None"])
