...
class SendEmail(cpm.CPModule):
    ...
    def add_when(self, can_delete = True):
        ...
        group.append("choice", cps.Choice(
            ...
            doc="""This setting controls the kind of event that causes
            <b>SendEmail</b> to send an email. You have the following choices:
            <br><ul><li><b>After first cycle</b> - Send an email during
            processing of the first image set.</li>
            <li><b>After last cycle</b> - Send an email after all processing
            is complete.</li>
            <li><b>After group start</b> - Send an email during the first
            cycle of each group of image sets.</li>
            <li><b>After group end</b> - Send an email after all processing
            for a group is complete.</li>
            <li><b>Every # of cycles</b> - Send an email each time a certain
            number of image sets has been processed. You will be prompted
            for the number of image sets if you select this choice.</li>
            <li<b>After cycle #</b> - Send an email after the given number
