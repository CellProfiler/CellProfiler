...
class IdentifyPrimaryObjects3d(
    ...
    module_name = "IdentifyPrimaryObjects3d"

    def __init__(self):
        self.threshold = threshold.Threshold()

        super(IdentifyPrimaryObjects3d, self).__init__()

    def volumetric(self):
        return True

    def create_settings(self):
        super(IdentifyPrimaryObjects3d, self).create_settings()
...
-  *{LIMIT_CHOICE_TEXT}*: {LIMIT_CHOICE_VALUE}""".format(
    ...
    def settings(self):
        settings = super(IdentifyPrimaryObjects3d, self).settings()
    ...
    def visible_settings(self):
        ...
        visible_settings += super(IdentifyPrimaryObjects3d, self).visible_settings()
    ...
    def run(self, workspace):
        ...
        (
            ...
            exclude_border_objects=self.exclude_border_objects.value,
        ...
        if self.show_window:
            ...
            if (
                ...
                if self.maxima_size.value > 1:
                    strel = skimage.morphology.ball(self.maxima_size.value - 1)
    ...
    def get_measurement_columns(self, pipeline):
        columns = super(IdentifyPrimaryObjects3d, self).get_measurement_columns(pipeline)
    ...
    def get_categories(self, pipeline, object_name):
        ...
        categories += super(IdentifyPrimaryObjects3d, self).get_categories(
    ...
    def get_measurements(self, pipeline, object_name, category):
        ...
        measurements += super(IdentifyPrimaryObjects3d, self).get_measurements(
