...
class MeasureImageIntensity(Module):
    ...
    def run(self, workspace):
        ...
        # measure_image_intensity_args = []
        # # 
        # # Option 1: Collect all images first by looping over images_list and then 
        # #           send all the images to the measure funciton. This will require 
        # #           loading all the images' pixel data into memory
        # #
        # # Option 2: Iterate over image names in FE and then call the measure function
        # #           for each image. This is more efficient as it requires less memory
        # #           But how would the role of module/measureimageintensity and function/measurements be different?
        # #
        # #
