    ...
    def get_threshold(self, input_image, workspace, automatic=False):
        ...
        if self.threshold_operation == ThresholdOpts.Method.MANUAL:
            ...
            if self.threshold_scope == ThresholdOpts.Scope.GLOBAL:
                if self.global_operation == ThresholdOpts.Method.OTSU and self.two_class_otsu == ThresholdOpts.OTSUThresholdMethod.THREE_CLASS:
                ...
                if self.local_operation == ThresholdOpts.Method.OTSU and self.two_class_otsu == ThresholdOpts.OTSUThresholdMethod.THREE_CLASS:
                    threshold_method = ThresholdOpts.Method.MULTI_OTSU
                else:
