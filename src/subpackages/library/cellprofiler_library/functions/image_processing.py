...
from typing import Annotated, Any, Optional, Tuple, Callable, Union, Sequence, List, cast, Dict, Union
from numpy.typing import NDArray
from skimage.util import invert as _invert
from numpy import isscalar as _isscalar
from centrosome.cpmorphology import fixup_scipy_ndimage_result as fix
from ..types import Image2D, ImageAny, ImageGrayscale, ImageGrayscaleMask, Image2DColor, Image2DGrayscale, Image2DMask, ObjectLabelsDense, ObjectLabelSet, ImageColor, ImageMaskAny
from ..opts import threshold as Threshold
from ..opts.enhanceorsuppressfeatures import SpeckleAccuracy, NeuriteMethod
from ..opts.overlayoutlines import BrightnessMode
from ..opts.crop import RemovalMethod
from ..opts.resize import ResizingMethod, DimensionMethod
from ..opts.imagemath import Operator
...
def spline_order(interpolation_method: str) -> int:
    ...
    from ..opts.resize import InterpolationMethod
...
def apply_resize(
    ...
    im_dimensions: int,
    im_crop_mask: Optional[NDArray[numpy.bool_]],
    size_method: str,
    resizing_factor_x: float,
    resizing_factor_y: float,
    resizing_factor_z: Optional[float],
...
def imagemath_apply_binary_operation(
    ...
    masks: Optional[List[Optional[Union[ImageMaskAny, bool]]]], 
    output_pixel_data: ImageAny, 
