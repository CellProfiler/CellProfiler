...
def image_math(
        ...
        masks:              Annotated[Optional[List[Optional[Union[ImageMaskAny, bool]]]], Field(description=" List of masks for the images. Use `True` for measurement operands")],
        output_pixel_data:  Annotated[ImageAny, Field(description=" Output image or measurement")],
        output_mask:        Annotated[Optional[ImageMaskAny], Field(description=" Output mask")],
