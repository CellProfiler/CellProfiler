...
import cellprofiler.extensions.align as A
...
class TestAlign(unittest.TestCase):
    ...
    def test_01_01_load_matlab(self):
        ...
        pipeline.load(fd)
        #
        # The pipeline has three extensions and Align is the third. It has
    ...
    def test_01_02_load_v1(self):
        ...
        pipeline.load(fd)
        #
        # There are two extensions and Align is the second. It has the
        # following settings:
        #
