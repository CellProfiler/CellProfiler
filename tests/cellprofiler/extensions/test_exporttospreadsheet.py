...
import cellprofiler.extensions.exporttospreadsheet as E
...
"""
    ...
    def test_00_00_no_measurements(self):
        ...
        object_set.add_objects(cpo.Object(), "my_object")
    ...
    def test_03_01_object_measurement(self):
        ...
        image_set = image_set_list.get_image_set(0)
        object_set = cpo.ObjectSet()
        object_set.add_objects(cpo.Object(), "my_objects")
        workspace = cpw.Workspace(self.make_measurements_pipeline(m),
                                  module,
                                  image_set,
                                  object_set,
    ...
    def test_03_03_get_measurements_from_two_objects(self):
        ...
        image_set = image_set_list.get_image_set(0)
        object_set = cpo.ObjectSet()
        object_set.add_objects(cpo.Object(), "object_0")
        object_set.add_objects(cpo.Object(), "object_1")
        workspace = cpw.Workspace(self.make_measurements_pipeline(m),
                                  module,
                                  image_set,
                                  object_set,
    ...
    def test_03_06_nan_image_measurements(self):
        ...
        image_set = image_set_list.get_image_set(0)
        object_set = cpo.ObjectSet()
        object_set.add_objects(cpo.Object(), OBJECTS_NAME)
        workspace = cpw.Workspace(self.make_measurements_pipeline(m),
                                  module,
                                  image_set,
                                  object_set,
