...
import cellprofiler.extensions.measureimagequality as miq
import cellprofiler.extensions.namesandtypes
import cellprofiler.extensions.loadsingleimage
import cellprofiler.extensions.smooth
...
"""
    ...
    def test_06_01_images_to_process(self):
        ...
        pipeline = cpp.Pipeline()
        module1 = cellprofiler.extensions.namesandtypes.NamesAndTypes()
        module1.module_num = 1
        module1.assignment_method.value = \
            cellprofiler.extensions.namesandtypes.ASSIGN_RULES
        module1.add_assignment()
        module1.add_assignment()
        module1.assignments[0].image_name.value = expected_names[0]
        module1.assignments[0].load_as_choice.value = \
            cellprofiler.extensions.namesandtypes.LOAD_AS_GRAYSCALE_IMAGE
        #
        # TO_DO: issue #652
        ...
        module1.assignments[1].load_as_choice.value = \
            cellprofiler.extensions.namesandtypes.LOAD_AS_ILLUMINATION_FUNCTION
        module1.assignments[2].load_as_choice.value = \
            cellprofiler.extensions.namesandtypes.LOAD_AS_OBJECTS
        pipeline.add_module(module1)

        module2 = cellprofiler.extensions.smooth.Smooth()
