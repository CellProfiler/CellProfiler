...
from tests.cellprofiler.extensions import example_images_directory, testimages_directory
    ...
    def check_display_post_run_requests(self, pipeline):
        ...
        for module in pipeline.modules():
            if module.show_window and \
                            module.__class__.display_post_run != cpm.Extension.display_post_run:
