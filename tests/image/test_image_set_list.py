...
class TestImageSetList:
    ...
    def test_add_image_provider(self):
        ...
        z = cellprofiler_core.image.abstract_image_provider._callback_image_provider.CallbackImageProvider("TestImageProvider", fn)
    ...
    def test_add_two_image_providers(self):
        ...
        y.providers.append(
            cellprofiler_core.image.abstract_image_provider._callback_image_provider.CallbackImageProvider("IP1", fn1))
        y.providers.append(
            cellprofiler_core.image.abstract_image_provider._callback_image_provider.CallbackImageProvider("IP2", fn2))
