...
class TestColorToGray(unittest.TestCase):
    ...
    def get_my_volume(self):
        volume = np.zeros((10, 32, 32, 3))

        volume[:, 0:25, 0:25, 0] = 1
        volume[:, 0:25, 25:50, 1] = 1
        volume[:, 25:50, 0:25, 2] = 1
    ...
    def test_01_01_combine_volume(self):
        img = self.get_my_volume()
        inj = cellprofiler.modules.injectimage.InjectImage("my_image", img, dimensions=3)
        inj.module_num = 1
        ctg = cellprofiler.modules.colortogray.ColorToGray()
        ctg.module_num = 2
        ctg.image_name.value = "my_image"
        ...
        self.assertTrue(grayscale)
        img = grayscale.image
        self.assertAlmostEqual(img[0, 0, 25], 1.0 / 3.0)
        self.assertAlmostEqual(img[0, 25, 0], 1.0 / 2.0)
        self.assertAlmostEqual(img[0, 25, 25], 0)
        self.assertAlmostEqual(img[-1, 0, 25], 1.0 / 3.0)
        self.assertAlmostEqual(img[-1, 25, 0], 1.0 / 2.0)
        self.assertAlmostEqual(img[-1, 25, 25], 0)
    ...
    def test_01_02_split_all_volume(self):
        img = self.get_my_volume()
        inj = cellprofiler.modules.injectimage.InjectImage(
            "my_image",
            img,
            dimensions=3
        )
        ...
        self.assertTrue(red)
        img = red.image
        self.assertAlmostEqual(img[0, 0, 0], 1)
        self.assertAlmostEqual(img[0, 0, 25], 0)
        self.assertAlmostEqual(img[0, 25, 0], 0)
        self.assertAlmostEqual(img[0, 25, 25], 0)
        self.assertAlmostEqual(img[-1, 0, 0], 1)
        self.assertAlmostEqual(img[-1, 0, 25], 0)
        self.assertAlmostEqual(img[-1, 25, 0], 0)
        self.assertAlmostEqual(img[-1, 25, 25], 0)
        green = image_set.get_image("my_green")
        self.assertTrue(green)
        img = green.image
        self.assertAlmostEqual(img[0, 0, 0], 0)
        self.assertAlmostEqual(img[0, 0, 25], 1)
        self.assertAlmostEqual(img[0, 25, 0], 0)
        self.assertAlmostEqual(img[0, 25, 25], 0)
        self.assertAlmostEqual(img[-1, 0, 0], 0)
        self.assertAlmostEqual(img[-1, 0, 25], 1)
        self.assertAlmostEqual(img[-1, 25, 0], 0)
        self.assertAlmostEqual(img[-1, 25, 25], 0)
        blue = image_set.get_image("my_blue")
        self.assertTrue(blue)
        ...
        self.assertAlmostEqual(img[0, 0, 0], 0)
        self.assertAlmostEqual(img[0, 0, 25], 0)
        self.assertAlmostEqual(img[0, 25, 0], 1)
        self.assertAlmostEqual(img[0, 25, 25], 0)
        self.assertAlmostEqual(img[-1, 0, 0], 0)
        self.assertAlmostEqual(img[-1, 0, 25], 0)
        self.assertAlmostEqual(img[-1, 25, 0], 1)
        self.assertAlmostEqual(img[-1, 25, 25], 0)
