...
def test_load_v2():
    file = os.path.join(tests.modules.test_resources_directory(), "colortogray/v2.pipeline")
...
def test_load_v3():
    ...
    """
    file = os.path.join(tests.modules.test_resources_directory(), "colortogray/v3.pipeline")
    with open(file, "r") as fd:
        data = fd.read()
