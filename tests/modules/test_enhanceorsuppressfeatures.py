...
class TestEnhanceOrSuppressSpeckles(unittest.TestCase):
    ...
    def test_01_00_check_version(self):
        ...
        self.assertEqual(cellprofiler.modules.enhanceorsuppressfeatures.EnhanceOrSuppressFeatures.variable_revision_number, 5)
...
'''
    ...
    def test_04_01_enhance_neurites(self):
        ...
        data = numpy.array([[7, 9, 5, 6, 3, 3, 6, 4, 1, 6, 4, 4, 3, 3, 9, 6, 2, 8, 7, 2, 7, 7, 7, 3, 7, 5, 4, 7, 4, 4, 4,
        ...
        expected = numpy.array([[43, 67, 24, 35, 0, 0, 31, 8, 0, 31, 8, 8, 0, 0, 63, 31, 0, 55, 43, 0, 43, 43, 47, 0, 43,
    ...
    def test_08_01_enhance_variance(self):
        ...
        module.run(workspace)
        expected = cellprofiler.modules.enhanceorsuppressfeatures.variance_transform(img, sigma)
        result = workspace.image_set.get_image(OUTPUT_IMAGE_NAME).pixel_data
        numpy.testing.assert_almost_equal(result, expected)
    ...
    def test_08_02_enhance_variance_masked(self):
        ...
        module.smoothing.value = sigma
        module.run(workspace)
        expected = cellprofiler.modules.enhanceorsuppressfeatures.variance_transform(img, sigma, mask)
        result = workspace.image_set.get_image(OUTPUT_IMAGE_NAME).pixel_data
