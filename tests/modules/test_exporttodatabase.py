...
class TestExportToDatabase(unittest.TestCase):
    ...
    def get_sqlite_cursor(self, module):
        ...
        self.assertTrue(isinstance(module, cellprofiler.modules.exporttodatabase.ExportToDatabase))
    ...
    def test_01_00_00_write_load_test(self):
        ...
        # number change.
        #
        self.assertEqual(cellprofiler.modules.exporttodatabase.ExportToDatabase.variable_revision_number, 27)
...
"""
        ...
        self.assertTrue(isinstance(module, cellprofiler.modules.exporttodatabase.ExportToDatabase))
        self.assertEqual(module.directory.dir_choice, cellprofiler.modules.exporttodatabase.DEFAULT_OUTPUT_FOLDER_NAME)
        ...
        self.assertEqual(module.db_type, cellprofiler.modules.exporttodatabase.DB_MYSQL)
...
"""
        ...
        self.assertEqual(module.sql_file_prefix, "SQLFile_")
        self.assertEqual(module.db_name, "MyDatabase")
        self.assertEqual(module.db_type, cellprofiler.modules.exporttodatabase.DB_MYSQL_CSV)
        self.assertTrue(module.save_cpa_properties)
...
"""
        ...
        self.assertTrue(module.wants_agg_std_dev)
        self.assertTrue(module.wants_agg_median)
        self.assertEqual(module.objects_choice, cellprofiler.modules.exporttodatabase.O_SELECT)
...
"""
        ...
        self.assertEqual(module.directory.dir_choice,
                         cellprofiler.modules.exporttodatabase.DEFAULT_OUTPUT_SUBFOLDER_NAME)
...
"""
        ...
        self.assertTrue(isinstance(module, cellprofiler.modules.exporttodatabase.ExportToDatabase))
        self.assertEqual(module.db_type, cellprofiler.modules.exporttodatabase.DB_MYSQL)
        self.assertEqual(module.directory.dir_choice, cellprofiler.modules.exporttodatabase.DEFAULT_OUTPUT_SUBFOLDER_NAME)
        self.assertEqual(module.directory.custom_path, r"./\g<Plate>")
        self.assertEqual(module.sql_file_prefix, "SQL_")
        self.assertEqual(module.db_name, "DefaultDB")
...
"""
        ...
        self.assertEqual(module.directory.dir_choice, cellprofiler.modules.exporttodatabase.ABSOLUTE_FOLDER_NAME)
        ...
        self.assertTrue(module.wants_agg_median_well)
        self.assertFalse(module.wants_agg_std_dev_well)
        self.assertEqual(module.objects_choice, cellprofiler.modules.exporttodatabase.O_ALL)
        self.assertEqual(module.max_column_size, 62)
        self.assertEqual(module.separate_object_tables, cellprofiler.modules.exporttodatabase.OT_PER_OBJECT)
...
"""
        ...
        self.assertEqual(module.directory.dir_choice, cellprofiler.setting.DEFAULT_OUTPUT_FOLDER_NAME)
        self.assertTrue(module.save_cpa_properties)
        ...
        for (g, measurement_display, x_measurement_type, x_object_name,
             ...
             y_measurement_name, y_index_name) in (
                (module.workspace_measurement_groups[0], "ScatterPlot",
                 cellprofiler.measurement.IMAGE, "Mitochondria", "Width_DNA", "ImageNumber",
                 cellprofiler.measurement.IMAGE, "Nuclei", "Height_DNA", "ImageNumber"),
                (module.workspace_measurement_groups[1], "PlateViewer",
                 cellprofiler.measurement.IMAGE, "Cells", "Height_Actin", "ImageNumber",
                 cellprofiler.measurement.IMAGE, "Speckles", "Width_Actin", "ImageNumber")):
...
"""
        ...
        self.assertEqual(g.filter_name, "Site1Filter")
        self.assertEqual(g.filter_statement, "Image_Metadata_Plate = '1'")
        self.assertEqual(module.allow_overwrite, cellprofiler.modules.exporttodatabase.OVERWRITE_DATA)
...
"""
        ...
        self.assertEqual(g.filter_name, "Site1Filter")
        self.assertEqual(g.filter_statement, "Image_Metadata_Plate = '1'")
        self.assertEqual(module.allow_overwrite, cellprofiler.modules.exporttodatabase.OVERWRITE_NEVER)
...
"""
        ...
        self.assertEqual(module.properties_class_table_name, "Hoopla")
        self.assertTrue(module.wants_relationship_table)
        self.assertEqual(module.properties_classification_type, cellprofiler.modules.exporttodatabase.CT_OBJECT)
        self.assertEqual(len(module.image_groups), 2)
        for image_group, input_image_name, output_image_name, color in (
                (module.image_groups[0], "DNA", "NucleicAcid", "green"),
                (module.image_groups[1], "Actin", "Protein", "blue")):
...
"""
        ...
        self.assertEqual(module.properties_classification_type, cellprofiler.modules.exporttodatabase.CT_IMAGE)
    ...
    def make_workspace(self, wants_files, alt_object=False,
        ...
        class TestModule(cellprofiler.module.Module):
            ...
            def create_settings(self):
                self.image_name = cellprofiler.setting.ImageNameProvider("Foo", IMAGE_NAME)
                self.objects_name = cellprofiler.setting.ObjectNameProvider("Bar", OBJECT_NAME)
                if alt_object:
                    self.altobjects_name = cellprofiler.setting.ObjectNameProvider("Baz", ALTOBJECT_NAME)
            ...
            def get_measurement_columns(self, pipeline):
                columns = [(cellprofiler.measurement.IMAGE, INT_IMG_MEASUREMENT, cellprofiler.measurement.COLTYPE_INTEGER),
                           (cellprofiler.measurement.IMAGE, FLOAT_IMG_MEASUREMENT, cellprofiler.measurement.COLTYPE_FLOAT),
                           (cellprofiler.measurement.IMAGE, STRING_IMG_MEASUREMENT,
                            cellprofiler.measurement.COLTYPE_VARCHAR_FORMAT % 40),
                           (cellprofiler.measurement.IMAGE, OBJECT_COUNT_MEASUREMENT, cellprofiler.measurement.COLTYPE_INTEGER),
                ...
                if self.in_module(alt_object):
                    columns += [(cellprofiler.measurement.IMAGE, ALTOBJECT_COUNT_MEASUREMENT, cellprofiler.measurement.COLTYPE_INTEGER),
                                (ALTOBJECT_NAME, cellprofiler.modules.identify.M_NUMBER_OBJECT_NUMBER, cellprofiler.measurement.COLTYPE_INTEGER),
                                (ALTOBJECT_NAME, OBJ_MEASUREMENT, cellprofiler.measurement.COLTYPE_FLOAT)]
                if self.in_module(long_measurement):
                    columns += [(cellprofiler.measurement.IMAGE, LONG_IMG_MEASUREMENT, cellprofiler.measurement.COLTYPE_INTEGER),
                                (OBJECT_NAME, LONG_OBJ_MEASUREMENT, cellprofiler.measurement.COLTYPE_FLOAT)]
                if self.in_module(wierd_measurement):
                    columns += [(cellprofiler.measurement.IMAGE, WIERD_IMG_MEASUREMENT, cellprofiler.measurement.COLTYPE_INTEGER),
                                (OBJECT_NAME, WIERD_OBJ_MEASUREMENT, cellprofiler.measurement.COLTYPE_FLOAT)]
                if self.in_module(well_metadata):
                    columns += [
                        (cellprofiler.measurement.IMAGE, "Metadata_Plate", cellprofiler.measurement.COLTYPE_VARCHAR_FORMAT % 20),
                        (cellprofiler.measurement.IMAGE, "Metadata_Well", cellprofiler.measurement.COLTYPE_VARCHAR_FORMAT % 3)]
                if self.in_module(group_measurement):
                    d = {cellprofiler.measurement.MCA_AVAILABLE_POST_GROUP: True}
                    columns += [
                        (cellprofiler.measurement.IMAGE, GROUP_IMG_MEASUREMENT, cellprofiler.measurement.COLTYPE_INTEGER, d),
                        (OBJECT_NAME, GROUP_OBJ_MEASUREMENT, cellprofiler.measurement.COLTYPE_FLOAT, d)]
                if post_run_test:
                    columns += [(cellprofiler.measurement.EXPERIMENT, STRING_IMG_MEASUREMENT,
            ...
            def get_categories(self, pipeline, object_name):
                return ([M_CATEGORY, cellprofiler.modules.identify.C_NUMBER]
            ...
            def get_measurements(self, pipeline, object_name, category):
                if category == M_CATEGORY:
                ...
                elif category == cellprofiler.modules.identify.C_NUMBER and object_name in (OBJECT_NAME, ALTOBJECT_NAME):
                    ...
                    return result
                elif category == "Metadata" and object_name == cellprofiler.measurement.IMAGE:
                    return ["Plate", "Well"]
                return []
        ...
        for i in range(image_set_count):
            ...
            m.add_measurement(OBJECT_NAME, cellprofiler.modules.identify.M_NUMBER_OBJECT_NUMBER,
            ...
            if TestModule.in_measurements(alt_object):
                m.add_measurement(ALTOBJECT_NAME, cellprofiler.modules.identify.M_NUMBER_OBJECT_NUMBER,
                                  numpy.arange(100) + 1)
        ...
        if relationship_test_type == self.RTEST_SOME:
            n = 10
            i1, o1 = [x.flatten() for x in numpy.mgrid[1:(image_set_count + 1), 1:(n + 1)]]
        ...
        if wants_files or well_metadata:
            ...
            module.directory.dir_choice = cellprofiler.modules.exporttodatabase.ABSOLUTE_FOLDER_NAME
    ...
    def load_database(self, output_dir, module, image_set_count=1):
        ...
        try:
            ...
            image_file = os.path.join(output_dir, base_name + "_" + cellprofiler.measurement.IMAGE + ".CSV")
            if module.separate_object_tables == cellprofiler.modules.exporttodatabase.OT_PER_OBJECT:
    ...
    def tteesstt_no_relationships(self, module, cursor):
        for t in (cellprofiler.modules.exporttodatabase.T_RELATIONSHIPS, cellprofiler.modules.exporttodatabase.V_RELATIONSHIPS):
            statement = "select count('x') from %s" % module.get_table_name(t)
            cursor.execute(statement)
            self.assertEqual(cursor.fetchall()[0][0], 0)

    def tteesstt_relate(self, measurements, module, cursor):
        v_name = module.get_table_name(cellprofiler.modules.exporttodatabase.V_RELATIONSHIPS)
        statement = ("select count('x') from %s "
                     "where %s=%d and %s='%s' and %s='%%s' and %s='%%s' "
                     "and %s = %%d and %s = %%d and %s = %%d and %s = %%d") % (
                        v_name, cellprofiler.modules.exporttodatabase.COL_MODULE_NUMBER, 1,
                        cellprofiler.modules.exporttodatabase.COL_RELATIONSHIP, RELATIONSHIP_NAME,
                        cellprofiler.modules.exporttodatabase.COL_OBJECT_NAME1, cellprofiler.modules.exporttodatabase.COL_OBJECT_NAME2,
                        cellprofiler.modules.exporttodatabase.COL_IMAGE_NUMBER1, cellprofiler.modules.exporttodatabase.COL_OBJECT_NUMBER1,
                        cellprofiler.modules.exporttodatabase.COL_IMAGE_NUMBER2, cellprofiler.modules.exporttodatabase.COL_OBJECT_NUMBER2)
    ...
    def test_02_01_write_mysql_db(self):
        ...
        try:
            ...
            module.directory.dir_choice = cellprofiler.modules.exporttodatabase.ABSOLUTE_FOLDER_NAME
            module.directory.custom_path = output_dir
            module.separate_object_tables.value = cellprofiler.modules.exporttodatabase.OT_COMBINE
            ...
            #
            self.assertFalse(module.wants_relationship_table)
            for t in (cellprofiler.modules.exporttodatabase.T_RELATIONSHIPS, cellprofiler.modules.exporttodatabase.T_RELATIONSHIP_TYPES):
        ...
        try:
            ...
            statement = ("select ImageNumber, ObjectNumber, %s_%s, %s_%s "
                         ...
                         (OBJECT_NAME, OBJ_MEASUREMENT,
                          OBJECT_NAME, cellprofiler.modules.identify.M_NUMBER_OBJECT_NUMBER,
        ...
        try:
            ...
            statement = ("select ImageNumber, ObjectNumber, %s_%s, %s_%s, "
                         ...
                         (OBJECT_NAME, OBJ_MEASUREMENT,
                          ...
                          ALTOBJECT_NAME, cellprofiler.modules.identify.M_NUMBER_OBJECT_NUMBER,
                          module.table_prefix.value))
            self.cursor.execute(statement)
            for i, value in enumerate(OBJ_VALUE):
                row = self.cursor.fetchone()
    ...
    def test_02_03_00_write_direct_long_colname(self):
        ...
        try:
            ...
            self.assertAlmostEqual(row[6], numpy.mean(OBJ_VALUE), 4)
            self.assertRaises(StopIteration, self.cursor.next)
    ...
    def test_02_04_01_write_nulls(self):
        ...
        try:
            ...
            self.assertEqual(row[3], STRING_VALUE)
            self.assertEqual(row[4], len(OBJ_VALUE))
            self.assertAlmostEqual(row[5], numpy.mean(om[~numpy.isnan(om)]))
            self.assertRaises(StopIteration, self.cursor.next)
            statement = ("select ImageNumber, ObjectNumber, %s_%s "
                         "from %sPer_Object order by ObjectNumber" %
                         (OBJECT_NAME, OBJ_MEASUREMENT, module.table_prefix.value))
    ...
    def test_02_04_02_write_inf(self):
        ...
        try:
            ...
            self.assertAlmostEqual(row[5], numpy.mean(om[mask]))
            self.assertRaises(StopIteration, self.cursor.next)
            statement = ("select ImageNumber, ObjectNumber, %s_%s "
                         "from %sPer_Object order by ObjectNumber" %
                         (OBJECT_NAME, OBJ_MEASUREMENT, module.table_prefix.value))
    ...
    def test_02_05_mysql_direct_null(self):
        ...
        try:
            ...
            self.assertEqual(row[3], STRING_VALUE)
            self.assertEqual(row[4], len(OBJ_VALUE))
            self.assertAlmostEqual(row[5], numpy.mean(om[numpy.isfinite(om)]))
            self.assertRaises(StopIteration, self.cursor.next)
            statement = ("select ImageNumber, ObjectNumber, %s_%s "
                         "from %sPer_Object order by ObjectNumber" %
                         (OBJECT_NAME, OBJ_MEASUREMENT, module.table_prefix.value))
    ...
    def per_object_statement(self, module, object_name, fields):
        ...
        statement = ("select ImageNumber, %s_%s, %s "
                     ...
                     (object_name, cellprofiler.modules.identify.M_NUMBER_OBJECT_NUMBER, field_string,
    ...
    def check_experiment_table(self, cursor, module, m):
        ...
        statement = "select %s, %s, %s from %s" % (
            cellprofiler.pipeline.M_PIPELINE, cellprofiler.pipeline.M_VERSION, cellprofiler.pipeline.M_TIMESTAMP,
        ...
        for feature, value in zip(
                (cellprofiler.pipeline.M_PIPELINE, cellprofiler.pipeline.M_VERSION, cellprofiler.pipeline.M_TIMESTAMP), row):
            self.assertEqual(
                    value,
    ...
    def test_05_01_write_mysql_db(self):
        ...
        try:
            ...
            module.directory.dir_choice = cellprofiler.modules.exporttodatabase.ABSOLUTE_FOLDER_NAME
            module.directory.custom_path = output_dir
            module.separate_object_tables.value = cellprofiler.modules.exporttodatabase.OT_PER_OBJECT
            module.post_run(workspace)
            self.load_database(output_dir, module)
    ...
    def test_05_11_data_tool_and_get_measurement_columns(self):
        ...
        try:
            ...
            for i in range(2):
                ...
                self.assertEqual(row[5], STRING_VALUE)
                self.assertEqual(row[6], len(OBJ_VALUE))
                self.assertAlmostEqual(row[7], numpy.mean(OBJ_VALUE), delta=.0001)
            self.assertRaises(StopIteration, self.cursor.next)
            statement = ("select ImageNumber, ObjectNumber, %s_%s, %s "
                         "from %sPer_Object order by ImageNumber, ObjectNumber" %
                         (OBJECT_NAME, OBJ_MEASUREMENT,
    ...
    def test_07_01_well_single_objtable(self):
        ...
        try:
            ...
            meas = ((cellprofiler.measurement.IMAGE, FLOAT_IMG_MEASUREMENT),
                    (cellprofiler.measurement.IMAGE, INT_IMG_MEASUREMENT),
                    (OBJECT_NAME, OBJ_MEASUREMENT))
            m = workspace.measurements
    ...
    def test_08_01_image_thumbnails(self):
        ...
        try:
            ...
            im = PIL.Image.open(StringIO.StringIO(result[0][0].decode('base64')))
    ...
    def test_08_02_image_thumbnails_sqlite(self):
        ...
        try:
            ...
            im = PIL.Image.open(StringIO.StringIO(str(result[0][0]).decode('base64')))
            self.assertEqual(tuple(im.size), (200, 200))
        finally:
            if cursor is not None:
                cursor.close()
    ...
    def test_09_02_post_group_single_object_table_agg(self):
        ...
        try:
            ...
            for i in range(count):
                ...
                self.assertEqual(row[0], i + 1)
                self.assertEqual(row[1], INT_VALUE)
                self.assertAlmostEqual(row[2], numpy.mean(OBJ_VALUE), 4)
            self.assertRaises(StopIteration, self.cursor.next)
            #
            # Read the object data
            #
    ...
    def test_09_05_post_group_object_view(self):
        ...
        module.wants_agg_std_dev.value = False
        try:
            module.separate_object_tables.value = cellprofiler.modules.exporttodatabase.OT_VIEW
            module.prepare_run(workspace)
            module.prepare_group(workspace, {}, numpy.arange(count) + 1)
            for i in range(count):
                workspace.set_image_set_for_testing_only(i + 1)
    ...
    def test_10_01_properties_file(self):
        old_get_measurement_columns = cellprofiler.modules.exporttodatabase.ExportToDatabase.get_measurement_columns
        ...
        def get_measurement_columns(
            ...
            result = [(cellprofiler.measurement.IMAGE,
                       cellprofiler.modules.exporttodatabase.C_FILE_NAME + "_" + IMAGE_NAME,
                       cellprofiler.measurement.COLTYPE_VARCHAR),
                      (cellprofiler.measurement.IMAGE,
                       cellprofiler.modules.exporttodatabase.C_PATH_NAME + "_" + IMAGE_NAME,
                       cellprofiler.measurement.COLTYPE_VARCHAR)] + \
                     old_get_measurement_columns(self, pipeline)
            return result

        cellprofiler.modules.exporttodatabase.ExportToDatabase.get_measurement_columns = get_measurement_columns
        workspace, module, output_dir, finally_fn = self.make_workspace(
                True, alt_object=True)
        self.assertTrue(isinstance(module, cellprofiler.modules.exporttodatabase.ExportToDatabase))
        ...
        try:
            ...
            for k, v in (
                    ...
                    ("image_path_cols", "%s_%s_%s" % (cellprofiler.measurement.IMAGE, cellprofiler.modules.exporttodatabase.C_PATH_NAME, IMAGE_NAME)),
                    ("image_file_cols", "%s_%s_%s" % (cellprofiler.measurement.IMAGE, cellprofiler.modules.exporttodatabase.C_FILE_NAME, IMAGE_NAME))):
                self.assertTrue(dictionary.has_key(k))
                self.assertEqual(dictionary[k], v)
        finally:
            cellprofiler.modules.exporttodatabase.ExportToDatabase.get_measurement_columns = old_get_measurement_columns
            os.chdir(output_dir)
    ...
    def test_12_08_add_relationship_id_mysql(self):
        ...
        try:
            ...
            #
            module.get_dictionary()[cellprofiler.modules.exporttodatabase.T_RELATIONSHIP_TYPES] = {}
            self.cursor.execute("delete from %s" %
                                module.get_table_name(cellprofiler.modules.exporttodatabase.T_RELATIONSHIP_TYPES))
            self.close_connection()
            module.run(workspace)
            self.tteesstt_relate(workspace.measurements, module, self.cursor)
        finally:
    ...
    def test_12_10_add_relationship_id_sqlite(self):
        for with_interaction_handler in (False, True):
            ...
            try:
                ...
                module.prepare_run(workspace)
                module.prepare_group(workspace, {}, [1])
                with cellprofiler.modules.exporttodatabase.DBContext(module) as (connection, cursor):
                    cursor.execute(
                            "delete from %s" %
                            module.get_table_name(cellprofiler.modules.exporttodatabase.T_RELATIONSHIP_TYPES))
                module.get_dictionary()[cellprofiler.modules.exporttodatabase.T_RELATIONSHIP_TYPES] = {}
    ...
    def test_13_02_mysql_keep_schema(self):
        ...
        try:
            ...
            how_many = "select count('x') from %s" % \
                       module.get_table_name(cellprofiler.measurement.IMAGE)
    ...
    def test_15_01_post_run_experiment_measurement_mysql(self):
        ...
        try:
            ...
            module.objects_choice.value = cellprofiler.modules.exporttodatabase.O_ALL
            module.separate_object_tables.value = cellprofiler.modules.exporttodatabase.OT_COMBINE
            workspace.measurements[cellprofiler.measurement.EXPERIMENT,
                                   STRING_IMG_MEASUREMENT] = STRING_VALUE
            self.assertTrue(module.prepare_run(workspace))
            self.cursor.execute(
                    "select %s from %s" %
                    (STRING_IMG_MEASUREMENT, module.get_table_name(cellprofiler.measurement.EXPERIMENT)))
