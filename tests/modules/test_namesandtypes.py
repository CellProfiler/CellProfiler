...
"""
    ...
    def do_teest(
        self, module, channels, expected_tags, expected_metadata, additional=None
    ):
    ...
    def make_ipd(self, url, metadata, series=0, index=0, channel=None):
        ...
        jipd = javabridge.run_script(
            """
                ...
                """,
            dict(
                url=url, metadata=jmetadata, series=series, index=index, channel=channel
            ),
        )
    ...
    def run_workspace(
        ...
        if load_as_type == cellprofiler.modules.namesandtypes.LOAD_AS_OBJECTS:
            ...
            series_feature = (
                cellprofiler.measurement.C_OBJECTS_SERIES + "_" + OBJECTS_NAME
            )
            frame_feature = (
                cellprofiler.measurement.C_OBJECTS_FRAME + "_" + OBJECTS_NAME
            )
            channel_feature = (
        ...
        for d in lsi:
            ...
            if load_as_type == cellprofiler.modules.namesandtypes.LOAD_AS_OBJECTS:
                ...
                channel_feature = (
                    cellprofiler.measurement.C_OBJECTS_CHANNEL + "_" + name
                )
            else:
