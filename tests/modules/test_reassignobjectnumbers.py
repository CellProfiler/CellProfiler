...
"""
    ...
    def test_02_01_split_zero(self):
        ...
        count = m.get_current_image_measurement(cellprofiler.identify.FF_COUNT % OUTPUT_OBJECTS_NAME)
        self.assertEqual(count, 0)
        for feature_name in (cellprofiler.identify.M_LOCATION_CENTER_X, cellprofiler.identify.M_LOCATION_CENTER_Y):
        ...
        for object_name, feature_name, coltype in (
                (OUTPUT_OBJECTS_NAME, cellprofiler.identify.M_LOCATION_CENTER_X, cellprofiler.measurement.COLTYPE_FLOAT),
                (OUTPUT_OBJECTS_NAME, cellprofiler.identify.M_LOCATION_CENTER_Y, cellprofiler.measurement.COLTYPE_FLOAT),
                (OUTPUT_OBJECTS_NAME, cellprofiler.identify.M_NUMBER_OBJECT_NUMBER, cellprofiler.measurement.COLTYPE_INTEGER),
                (INPUT_OBJECTS_NAME, cellprofiler.identify.FF_CHILDREN_COUNT % OUTPUT_OBJECTS_NAME,
                 cellprofiler.measurement.COLTYPE_INTEGER),
                (OUTPUT_OBJECTS_NAME, cellprofiler.identify.FF_PARENT % INPUT_OBJECTS_NAME,
                 cellprofiler.measurement.COLTYPE_INTEGER),
                (cellprofiler.measurement.IMAGE, cellprofiler.identify.FF_COUNT % OUTPUT_OBJECTS_NAME, cellprofiler.measurement.COLTYPE_INTEGER)):
    ...
    def test_02_02_split_one(self):
        ...
        for feature_name, value in ((cellprofiler.identify.M_LOCATION_CENTER_X, 5),
                                    (cellprofiler.identify.M_LOCATION_CENTER_Y, 3),
                                    (cellprofiler.identify.FF_PARENT % INPUT_OBJECTS_NAME, 1)):
            values = m.get_current_measurement(OUTPUT_OBJECTS_NAME,
                                               feature_name)
        ...
        values = m.get_current_measurement(INPUT_OBJECTS_NAME,
                                           cellprofiler.identify.FF_CHILDREN_COUNT % OUTPUT_OBJECTS_NAME)
        self.assertEqual(len(values), 1)
    ...
    def test_02_03_split_one_into_two(self):
        ...
        m = workspace.measurements
        values = m.get_current_measurement(OUTPUT_OBJECTS_NAME,
                                           cellprofiler.identify.FF_PARENT % INPUT_OBJECTS_NAME)
