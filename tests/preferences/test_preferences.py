...
class TestPreferences(unittest.TestCase):
    def test_01_01_folder_translations(self):
        for expected, value in (
            ...
            (cellprofiler_core.preferences.ABSOLUTE_FOLDER_NAME, "Absolute path elsewhere"),
            (cellprofiler_core.preferences.DEFAULT_INPUT_FOLDER_NAME, "Default Input Folder"),
            (cellprofiler_core.preferences.DEFAULT_OUTPUT_FOLDER_NAME, "Default Output Folder"),
            (
                    cellprofiler_core.preferences.DEFAULT_INPUT_SUBFOLDER_NAME,
            ...
            assert expected == cellprofiler_core.preferences.FOLDER_CHOICE_TRANSLATIONS[value]
    ...
    def test_01_02_slot_translations(self):
        for expected, value in (
            ...
            (cellprofiler_core.preferences.DEFAULT_INPUT_FOLDER_NAME, "Default Image Directory"),
        ):
            for i in range(3):
    ...
    def test_01_03_unicode_directory(self):
        ...
        assert cellprofiler_core.preferences.get_default_image_directory() == unicode_dir
...
class TestPreferences_02(unittest.TestCase):
    def setUp(self):
        ...
        self.old_headless_config = cellprofiler_core.preferences.__dict__["__headless_config"]
    ...
    def tearDown(self):
        ...
        cellprofiler_core.preferences.__dict__["__headless_config"] = self.old_headless_config
