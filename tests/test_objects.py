...
class TestSegmentation(unittest.TestCase):
    ...
    def test_01_02_sparse(self):
        ...
        ijv = numpy.core.records.fromarrays(
            ...
            [
                (
                    cellprofiler.utilities.hdf5_dict.HDF5ObjectSet.AXIS_Y,
                    numpy.uint32,
                    1,
                ),
                (
                    cellprofiler.utilities.hdf5_dict.HDF5ObjectSet.AXIS_X,
                    numpy.uint32,
                    1,
                ),
                (
                    cellprofiler.utilities.hdf5_dict.HDF5ObjectSet.AXIS_LABELS,
                    numpy.uint32,
                    1,
                ),
            ],
    ...
    def test_02_01_sparse_to_dense(self):
        ...
        retrieval = dense[
            ...
            0,
            0,
            ijv[cellprofiler.utilities.hdf5_dict.HDF5ObjectSet.AXIS_Y],
            ijv[cellprofiler.utilities.hdf5_dict.HDF5ObjectSet.AXIS_X],
        ]
        matches = (
            retrieval
            == ijv[cellprofiler.utilities.hdf5_dict.HDF5ObjectSet.AXIS_LABELS][None, :]
        )
...
class TestCropLabelsAndImage(unittest.TestCase):
    def test_01_01_crop_same(self):
        labels, image = cellprofiler.object.crop_labels_and_image(
    ...
    def test_overlay_objects(self):
        ...
        overlay_pixel_data = cellprofiler.object.overlay_labels(
...
class TestSizeSimilarly(unittest.TestCase):
    def test_01_01_size_same(self):
        secondary, mask = cellprofiler.object.size_similarly(
            numpy.zeros((10, 20)), numpy.zeros((10, 20))
        )
