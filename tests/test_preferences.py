...
class TestPreferences(unittest.TestCase):
    def test_01_01_folder_translations(self):
        for expected, value in (
                ...
                (cellprofiler.preferences.DEFAULT_INPUT_FOLDER_NAME, cellprofiler.preferences.DEFAULT_INPUT_FOLDER_NAME),
                (cellprofiler.preferences.DEFAULT_OUTPUT_FOLDER_NAME, cellprofiler.preferences.DEFAULT_OUTPUT_FOLDER_NAME),
                (cellprofiler.preferences.DEFAULT_INPUT_SUBFOLDER_NAME, cellprofiler.preferences.DEFAULT_INPUT_SUBFOLDER_NAME),
                (cellprofiler.preferences.DEFAULT_OUTPUT_SUBFOLDER_NAME, cellprofiler.preferences.DEFAULT_OUTPUT_SUBFOLDER_NAME),
                (cellprofiler.preferences.ABSOLUTE_FOLDER_NAME, 'Absolute path elsewhere'),
                (cellprofiler.preferences.DEFAULT_INPUT_FOLDER_NAME, 'Default Input Folder'),
    ...
    def test_01_02_slot_translations(self):
        for expected, value in (
                ...
                (cellprofiler.preferences.DEFAULT_OUTPUT_FOLDER_NAME, 'Default Output Folder'),
                (cellprofiler.preferences.DEFAULT_INPUT_SUBFOLDER_NAME, 'Default input directory sub-folder'),
                (cellprofiler.preferences.DEFAULT_INPUT_SUBFOLDER_NAME, 'Default Input Folder sub-folder'),
                (cellprofiler.preferences.DEFAULT_OUTPUT_SUBFOLDER_NAME, 'Default output directory sub-folder'),
                (cellprofiler.preferences.DEFAULT_OUTPUT_SUBFOLDER_NAME, 'Default Output Folder sub-folder'),
                (cellprofiler.preferences.DEFAULT_INPUT_FOLDER_NAME, 'Default Image Directory')):
            for i in range(3):
                setting_values = ["foo", "bar", "baz"]
                setting_values[i] = value
                self.assertEqual(cellprofiler.preferences.standardize_default_folder_names(
    ...
    def test_01_03_unicode_directory(self):
        ...
        self.assertEqual(cellprofiler.preferences.config_read(cellprofiler.preferences.DEFAULT_IMAGE_DIRECTORY),
                         unicode_dir)
        self.assertEqual(cellprofiler.preferences.get_default_image_directory(), unicode_dir)
...
class TestPreferences_02(unittest.TestCase):
    def setUp(self):
        ...
        self.old_headless_config = cellprofiler.preferences.__dict__['__headless_config']
    ...
    def tearDown(self):
        ...
        cellprofiler.preferences.__dict__['__headless_config'] = self.old_headless_config
